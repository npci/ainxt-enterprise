...
# Optional authoring guidance. There is no such file in this repo by default, so
# the loader below degrades to the inline prompts — which is the behaviour that
...
_SKILL_CREATOR_MD = Path(
    os.getenv("AINXT_SKILL_GUIDANCE_MD")
    or (
        Path(__file__).resolve().parent.parent.parent
        / "skills" / "ainxt-skills" / "skill-authoring" / "SKILL.md"
    )
)
