...
# Resolved from core.model_registry rather than hardcoded, so that overriding a
# model id (or setting LLM_PROVIDER=local) actually reaches this alias table. When
# these ids were literals, a deployment running its own models still had "sonnet"
# resolve to a cloud model it had no credentials for -- the provider switch could
# not reach here. See docs/PROVIDERS.md.
try:
    from core.model_registry import (           # noqa: E402  (module-level table build)
...
_STRUCTURE_SYSTEM_PROMPT = (
            ...
            '- Optional evaluation gate (judged retries): {"id":"gate-1","type":"evaluation_gate","position":{"x":X,"y":Y},"data":{"criteria":"Response is factually accurate, complete, and cites sources","threshold":0.85,"stop_policy":"pass_or_max","judgeModel":"' + CLAUDE_PRIMARY_MODEL + '","maxRetries":3}}\n'
            ...
            "when maxRetries is reached), `judgeModel` (default \"" + CLAUDE_PRIMARY_MODEL + "\"), and `maxRetries` "
