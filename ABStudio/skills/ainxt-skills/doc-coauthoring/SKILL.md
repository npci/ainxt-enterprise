...
- If images exist without alt-text, explain that when others use an AI assistant to understand the doc, the AI won't be able to see them. Ask if they want alt-text generated. If so, request they paste each image into chat for descriptive alt-text generation.
