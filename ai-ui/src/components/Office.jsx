...
function OfficeServer() {
  ...
  // Model list must come from admin config (GET /all-models), same source
  // Chat.jsx/KbChat.jsx use — was previously a hardcoded MODELS array with no
  // API call at all, so admin-added/removed models never reflected here.
  // Refetched on mount AND right before the dropdown opens (onFocus below) —
  // otherwise a model an admin adds/syncs while this tab is already open
