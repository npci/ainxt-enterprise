...
export default function Sidebar({ view, setView, user, onLogout, unreadCount = 0, collapsed = false, onToggleCollapse }) {
  ...
  const navGroups = [
    ...
    [
      { view: "products",  icon: FolderKanban,  label: "Products",       maxLevel: 2 },
    ...
    [
      { view: "monitoring",       icon: Activity,     label: "Monitoring",       maxLevel: 3 },
      { view: "analytics",        icon: BarChart2,    label: "Analytics",        maxLevel: 3 },
      { view: "evals",            icon: FlaskConical, label: "Eval Observatory", maxLevel: 3 },
    ...
    `}>
      ...
      `}>
        {!collapsed && (
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
              <BrandMark className="w-5 h-5 drop-shadow-sm" />
            </div>
        ...
        {collapsed && (
          ...
          >
            <BrandMark className="w-7 h-7 drop-shadow-sm" />
          </button>
        )}
        {!collapsed && (
          <button
