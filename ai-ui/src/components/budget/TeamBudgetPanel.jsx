...
// Same singleton-promise pattern as piiEnabled() above.
...
export default function TeamBudgetPanel() {
  ...
  const [baseCost,     setBaseCost]     = useState(50);           // platform base allocation
        ...
        {!teamDrill && (
          <div className="mb-3 flex items-start gap-3 p-3 border border-gray-200 bg-gray-50 rounded-lg">
            ...
            <div className="text-xs text-gray-700">
              ...
              Everyone shares the same ${baseCost.toLocaleString()} base; extra budget comes only from approved HOD
              increase requests, and does not carry over month to month.
            </div>
          </div>
        )}
