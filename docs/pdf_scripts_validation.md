...
| [docskills_legacy.md](docskills_legacy.md) | Broader legacy document-skills context |
...
Within the larger platform, this pipeline is typically invoked by document-generation workers (see [document_knowledge_workers.md](document_knowledge_workers.md)) or by agentic skills that need to produce filled government forms, invoices, or reports. The validation step prevents downstream fill failures caused by overlapping fields or clipped text.
