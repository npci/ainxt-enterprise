...
For the actual application logic, routing, dashboards, and editors, see the [app_core](app_core.md) module and its feature-area children.
...
The only exported component in this module. It is intentionally thin: all business logic, state management, and feature UI live in [app_core](app_core.md) and the feature modules.
...
|------------|------------|---------|
| `App.jsx` | [app_core](app_core.md) | The actual Build Studio application shell, routing, and section state. |
| `AppErrorBoundary` | [app_core](app_core.md) | Catches errors inside the builder tree. |
| Feature components | [agents_feature](agents_feature.md), [workflows_feature](workflows_feature.md), [skills_feature](skills_feature.md), [templates_feature](templates_feature.md), [triggers_feature](triggers_feature.md), [tools_feature](tools_feature.md), [governance_feature](governance_feature.md) | Rendered by `App` based on the active section. |
| Shared UI | [shared_features](shared_features.md), [common_components](common_components.md) | Reusable chat shells, pickers, uploaders, and modals. |
| State stores | [store](store.md) | Workflow, trigger, and global UI state. |
...
Runtime errors inside the builder are caught by `AppErrorBoundary` (imported from [app_core](app_core.md)) before they can propagate to the host. This keeps the host shell stable even if a workflow editor, agent factory, or canvas throws.

---

## Related Documentation

- [app_core](app_core.md) — Main application shell, routing, and top-level state.
- [agents_feature](agents_feature.md) — Agent dashboard, editor, and factory chat.
- [workflows_feature](workflows_feature.md) — Workflow dashboard and factory chat.
- [workflow_editor](workflow_editor.md) — Visual workflow editor with React Flow canvas.
- [skills_feature](skills_feature.md) — Skill catalog and skill factory.
- [templates_feature](templates_feature.md) — Template gallery and admin operations.
- [triggers_feature](triggers_feature.md) — Trigger designer and execution history.
- [tools_feature](tools_feature.md) — Tool catalog management.
- [governance_feature](governance_feature.md) — Governance submission and status UI.
- [common_components](common_components.md) — Reusable low-level UI components.
- [shared_features](shared_features.md) — Cross-feature shared components.
- [store](store.md) — Client-side state management.
