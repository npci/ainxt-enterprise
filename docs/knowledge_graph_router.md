...
- **Authentication**: All routes depend on `auth.dependencies.get_current_user` (see [auth_router](auth_router.md) and [auth dependencies](shared_core.md#authentication)).
- **Job queue**: `build_graph` uses `core.job_queue.enqueue_job` with `Q_KB` to schedule asynchronous work (see [core infrastructure](shared_core.md#core-infrastructure)).
...
- **Frontend**: The web UI consumes these endpoints through `KnowledgeGraph.jsx`, `KbScopeGraph.jsx`, and `KbDrillGraph.jsx` (see [ai_ui_frontend knowledge_graph](ai_ui_frontend.md#knowledge-graph) and [kb_graph](ai_ui_frontend.md#kb-graph)).
...
- [auth dependencies](shared_core.md#authentication) - user authentication and JWT context.
- [core logger](shared_core.md#core-infrastructure) - structured logging.
- [core job queue](shared_core.md#core-infrastructure) - asynchronous job enqueueing.
- [db database](shared_core.md#database) - SQLAlchemy session management.
- [workers knowledge_graph_worker](workers.md#document-knowledge-workers) - graph construction and clustering.
- [workers index_worker](workers.md#external-integration-workers) - code-node mirroring during repo indexing.
- [workers kb_entity_worker](workers.md#document-knowledge-workers) - document entity extraction.
- [store kb_entity_registry](shared_core.md#shared-core-knowledge-base) - canonical entity resolution.
- [ai_ui_frontend KnowledgeGraph](ai_ui_frontend.md#knowledge-graph) - interactive graph visualization.
- [ai_ui_frontend KbScopeGraph / KbDrillGraph](ai_ui_frontend.md#kb-graph) - scope picker visualizations.
