...
- [`api/governance.py`](api_governance.md) — user-facing REST endpoints for submit, withdraw, and status.
- [`core/workflow_repo.py`](core_workflow_repo.md) — template instantiation and artifact update hooks.
...
- [`api/governance.py`](api_governance.md) — exposes the client as REST endpoints under `/ainxt/v1/api/abs/governance-*`.
- [`core/workflow_repo.py`](core_workflow_repo.md) — invokes the client during template use and artifact updates.
