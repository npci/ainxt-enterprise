...
- [broadcast_router.md](../api/broadcast_router.md) — HTTP API for broadcast creation, targeting, sending, and cancellation.
- [ai_ui_frontend_email_broadcast.md](../ai_ui_frontend_email_broadcast.md) — Admin UI for email broadcasts.
- [services_smtp_service.md](../services_smtp_service.md) — SMTP transport service used by this worker.
- [db_models.md](../db_models.md) — Database models including `EmailBroadcast`, `EmailBroadcastRecipient`, `EmailBroadcastAttachment`, and `EmailBroadcastAuditLog`.
- [core_logger.md](../core_logger.md) — Structured logging utilities.
