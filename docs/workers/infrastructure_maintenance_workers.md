...
| `core.job_queue.enqueue_job` | [core_infrastructure](../infrastructure/core_infrastructure.md) | Enqueues scheduled workflow and trigger fire jobs. |
| `core.kv.get_kv` | [core_infrastructure](../infrastructure/core_infrastructure.md) | Redis access for throttling, run records, and chunk quality. |
| `core.storage.storage` | [core_infrastructure](../infrastructure/core_infrastructure.md) | Deletes uploaded attachment blobs. |
| `core.ckms.load_at_boot` | [ckms](../reference/shared_core.md) | Decrypts protected env vars before imports. |
| `db.models` / `db.database` | [database](../reference/shared_core.md) | ORM models and sessions for purge and scheduling queries. |
| `memory.postgres_memory.PostgresMemory` | [memory_system](../reference/shared_core.md) | Stores and maintains memory entries and user preferences. |
| `services.feedback_processor.FeedbackProcessor` | [services](../reference/shared_core.md) | Extracts preferences and computes chunk quality penalties. |
| `app.core.workflow_repo` / `app.services.trigger_scheduler` | [abstudio_backend](../ui/abstudio_backend.md) | AB Studio trigger persistence and execution. |
