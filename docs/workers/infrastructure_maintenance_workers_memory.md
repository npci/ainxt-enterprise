...
Both operations are delegated to [`PostgresMemory`](../storage/memory_system.md) methods
...
[Memory System](../storage/memory_system.md) for the full upsert/merge/prune pipeline.
...
|---|---|---|
| `PostgresMemory` | [memory_system](../storage/memory_system.md) | Persistent memory layer — `expire_stale_memories()`, `decay_importance_scores()`, `store_memory()`, `save_user_memory()`. |
