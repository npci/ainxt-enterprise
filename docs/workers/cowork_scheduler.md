...
| Module | Relationship |
|--------|--------------|
| [cowork_desktop](../buddy/cowork_desktop.md) | Hosts the scheduler panel and provides the desktop runtime context. |
| [cowork_canvas](../ui/cowork_canvas.md) | Visual workspace for Cowork sessions; scheduler can be launched from the desktop shell. |
| [cowork_settings](../buddy/cowork_settings.md) | Configures permissions and roles used by scheduled tasks. |
| [cowork_enterprise](../buddy/cowork_enterprise.md) | Enterprise rules and limits may constrain scheduler usage. |

### 5.3 Backend dependencies

| Module | Relationship |
|--------|--------------|
| [cowork_tasks_router](../api/cowork_tasks_router.md) | REST API for task CRUD, run-now, and history. |
| [cowork_projects_router](../api/cowork_projects_router.md) | Supplies project context and scoping. |
| [cowork_admin_router](../api/cowork_admin_router.md) | Supplies published Cowork roles. |
...
- Related docs: [cowork_desktop](../buddy/cowork_desktop.md), [cowork_scheduling_workers](cowork_scheduling_workers.md), [cowork_tasks_router](../api/cowork_tasks_router.md), [worker_orchestration](worker_orchestration.md)
