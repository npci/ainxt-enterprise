...
- **[auth](../core/shared_core.md#authentication)** — `auth/ldap_handler.py` for AD sync.
- **[db](../core/shared_core.md#database)** — `db.database` for Postgres/pgvector sessions and SQLAlchemy engines.
