...
| [`core_workflow_repo`](../reference/core_workflow_repo.md) | **Data access** — provides the psycopg connection pool and trigger CRUD for Path B |
...
| [`core_infrastructure`](../infrastructure/core_infrastructure.md) | **Infrastructure** — `core.logger` and `core.job_queue` |
...
[`core_infrastructure`](../infrastructure/core_infrastructure.md)). Key log lines:
