...
See also: [chat_router.md](../chat/chat_router.md), [gateway.md](../core/gateway.md)
...
See also: [embedding_service.md](../knowledge/embedding_service.md), knowledge_graph_worker.md
...
See also: [threads_router.md](../chat/threads_router.md)
...
See also: sdlc_worker.md, [sdlc_router.md](../sdlc/sdlc_router.md)
...
See also: [budget_router.md](../llm/budget_router.md)
...
See also: agent_worker.md, [agents_router.md](../agents/agents_router.md)
...
- [gateway.md](../core/gateway.md) — primary producer of chat, metrics, audit, and SDLC events.
- [worker_orchestration.md](../workers/worker_orchestration.md) — starts and supervises the consumer.
- sdlc_worker.md — produces SDLC run events.
- agent_worker.md — produces agent conversation events.
- [chat_router.md](../chat/chat_router.md) / chat_worker.md — produce chat history events.
- [budget_router.md](../llm/budget_router.md) — produces budget events.
- core_telemetry.md — produces metrics events.
- [embedding_service.md](../knowledge/embedding_service.md) — produces embedding metadata events.
- [threads_router.md](../chat/threads_router.md) — produces thread events.
