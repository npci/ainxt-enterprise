...
- Deletes bytes via [`core.storage.storage.delete()`](../infrastructure/core_infrastructure.md) (supports MinIO and local disk).
...
|------------|------------|---------|
| `core.ckms.load_at_boot` | [core_infrastructure.md](../infrastructure/core_infrastructure.md) | Decrypts protected env vars before logger/DB imports |
| `core.logger` | [core_infrastructure.md](../infrastructure/core_infrastructure.md) | Structured logging |
| `core.config.RDB_QUEUE`, `RDB_TRACE` | [core_infrastructure.md](../infrastructure/core_infrastructure.md) | Logical KV DB numbers |
| `core.kv.get_kv` | [core_infrastructure.md](../infrastructure/core_infrastructure.md) | Backend-agnostic KV client |
| `core.storage.storage` | [core_infrastructure.md](../infrastructure/core_infrastructure.md) | MinIO/local object deletion |
...
- [core_infrastructure.md](../infrastructure/core_infrastructure.md) — shared config, logging, KV, and storage layers.
