...
- **[engine_native_engine](../reference/engine_native_engine.md)** — when `ABSTUDIO_CLI_MODE`
...
| [engine_native_engine](../reference/engine_native_engine.md) | Delegates agent-node execution to the CLI runtime when CLI mode is on. |
...
- [engine_native_engine](../reference/engine_native_engine.md) — Native orchestration engine with optional CLI execution branch.
