...
| ---------- | ------ | ---- |
| `BrandMark` | [brand_mark](../ui/brand_mark.md) | Logo component. |
| `apiFetch` | [config](../core/config.md) | Unauthenticated fetch wrapper that sends `credentials: include` and a correlation id. |
| `authFetch` | [config](../core/config.md) | Authenticated fetch wrapper with a single retry for idempotent GETs. |
...
- [budget_manager](../llm/budget_manager.md) / [level_overrides](../llm/level_overrides.md) — RBAC/ABAC-gated features.
...
- [config](../core/config.md) — `apiFetch` and `authFetch` wrappers.
- [brand_mark](../ui/brand_mark.md) — AiNxt logo component.
