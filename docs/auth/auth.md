...
| Module | Relationship |
| ------ | ------------ |
| [`auth_router`](../core/shared_api_routers.md#auth_router) | Provides login, register, refresh, logout, SSO, and session management endpoints. |
| [`shared_core_authentication`](../core/shared_core.md#authentication) | Contains RBAC, LDAP, and SSO logic used by the backend auth layer. |
...
- [`shared_api_routers.md#auth_router`](../core/shared_api_routers.md#auth_router) — Backend authentication endpoints.
- [`shared_core.md#authentication`](../core/shared_core.md#authentication) — Backend RBAC, LDAP, and SSO implementation.
