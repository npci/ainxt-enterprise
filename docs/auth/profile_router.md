...
- **Chat / Memory**: custom instructions may be consumed by [chat_router](../chat/chat_router.md) and [memory_router](../storage/memory_router.md) to shape persona-driven responses.
