...
For the authoritative implementation, see coach_evaluator.md.
...
The full catalog and evaluation engine are documented in coach_evaluator.md.
...
- coach_evaluator.md — rule engine and scoring.
- [coach_router.md](coach_router.md) — public Coach API.
- [coach_admin_router.md](coach_admin_router.md) — admin Coach API.
- coach_ingestor.md — event ingestion pipeline.
- coach_consumer.md — background evaluation worker.
