...
All API calls from the app shell use `authFetch` from the [config](config.md) module, which:
...
> **See also:** [config](config.md) module for `authFetch` and `apiFetch` implementation details.
...
|---|---|---|
| `authFetch`, `apiFetch` | [config](config.md) | Authenticated HTTP requests with retry and correlation IDs |
| `coworkOfficeClearKey` | [ai_ui_frontend_hooks](ai_ui_frontend_hooks.md) | Desktop bridge — clears OS-persisted CLI keys on logout |
| `Login` | [login](login.md) | Authentication screen with CAPTCHA and server-side session verification |
...
| `Chat` | [chat](chat.md) | Main chat interface (receives hoisted chat state) |
| `Office` | — | Buddy/Office component (keep-alive pattern) |
| `Projects` | [projects](projects.md) | Project workspace (receives hoisted project state) |
...
|---|---|---|---|
| `/chat` | `chat` | `Chat` | [chat](chat.md) |
| `/agents` | `agents` | `AgentsCatalog` | [agents_catalog](agents_catalog.md) |
| `/knowledge` | `knowledge` | `KnowledgeBase` | [knowledge_base](knowledge_base.md) |
| `/graph` | `graph` | `KnowledgeGraph` | [knowledge_graph](knowledge_graph.md) |
| `/products` | `products` | `ProductManager` | [product_manager](product_manager.md) |
| `/codebase` | `codebase` | `CodebaseManager` | [codebase_manager](codebase_manager.md) |
| `/projects` | `projects` | `Projects` | [projects](projects.md) |
| `/threads` | `threads` | `Threads` | [threads](threads.md) |
| `/discussions` | `discussions` | `Discussions` | [discussions](discussions.md) |
| `/inbox` | `inbox` | `Inbox` | [inbox](inbox.md) |
| `/sdlc` | `sdlc` | `SDLCPipeline` | [sdlc_pipeline](sdlc_pipeline.md) |
| `/build-studio` | `build-studio` | `BuildStudio` | [ai_ui_frontend_build_studio](ai_ui_frontend_build_studio.md) |
| `/monitoring` | `monitoring` | `Monitoring` | [monitoring](monitoring.md) |
| `/analytics` | `analytics` | `AgentAnalytics` | [agent_analytics](agent_analytics.md) |
| `/evals` | `evals` | `EvalsDashboard` | [evals_dashboard](evals_dashboard.md) |
| `/model-governance` | `model-governance` | `ModelGovernance` | [model_governance](model_governance.md) |
| `/budget-manager` | `budget` | `BudgetManager` | [budget_manager](budget_manager.md) |
| `/level-overrides` | `level-overrides` | `LevelOverrides` | [level_overrides](level_overrides.md) |
| `/broadcast` | `broadcast` | `EmailBroadcast` | [email_broadcast](email_broadcast.md) |
| `/endpoint-manager` | `endpoint-manager` | `EndpointManager` | [endpoint_manager](endpoint_manager.md) |
| `/dept-metrics` | `dept-metrics` | `DeptMetrics` | [dept_metrics](dept_metrics.md) |
| `/memory` | `memory` | `Memory` | [memory](memory.md) |
| `/connectors` | `connectors` | `Connectors` | [connectors](connectors.md) |
| `/cowork-setup` | `cowork-setup` | `CoworkSettings` | [cowork_settings](cowork_settings.md) |
| `/office` | `office` | `Office` (keep-alive) | — |
| `/code` | `cowork` | `Code` | [code](code.md) |
| `/documents` | `docs` | `DocsPanel` | [documents](documents.md) |
| `/profile` | `profile` | `Profile` | [profile](profile.md) |
| `/tenx` | `tenx` | `TenXAward` | — |
| `/coach` | `coach` | `Coach` | [coach](coach.md) |
| `/skill-proposals` | `skill-proposals` | `SkillProposals` | [skill_proposals](skill_proposals.md) |
...
> **See also:** [gateway](gateway.md) module for the backend API gateway that serves these endpoints.
...
> **See also:** [desktop_app](desktop_app.md) module for the Electron desktop application and IPC bridge.
