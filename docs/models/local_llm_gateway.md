...
|------------|---------------------|
| [`core.logger`](../core_logger.md) | Structured logging and request-id propagation. |
| [`core.model_registry`](../core_model_registry.md) | Cost registry (`MODEL_COST_PER_1M`), generic local sentinel (`LOCAL_LLM_MODEL_NAME`), and vision model list (`LOCAL_VISION_MODELS`). |
| [`core.prompt_sanitizer`](../core_prompt_sanitizer.md) | Sanitizes message content before sending to the local proxy. |
| [`core.ckms.bootstrap`](../core_ckms.md) | Decrypts `LOCAL_LLM_API_KEY` / `LITELLM_API_KEY` at import time. |
| [`gateway.py`](gateway.md) | Exposes `/local-models` and `/all-models` endpoints that call this gateway. |
...
See [`gateway.md`](gateway.md) for the full model-listing logic.
...
See [`models/model_router.md`](../model_router.md) for routing policy details.
