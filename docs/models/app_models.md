...
See [services_trigger_scheduler.md](../workers/services_trigger_scheduler.md) and [api_triggers.md](../api/api_triggers.md) for how these schemas are scheduled and exposed.
...
- [`app_main.md`](../reference/app_main.md) — FastAPI application wiring.
- [`api_execution.md`](../api/api_execution.md) — `run_workflow_stream`, `run_workflow`, `resume_workflow_stream_endpoint`.
- [`api_workflows.md`](../api/api_workflows.md) — workflow CRUD routes.
- [`api_agents.md`](../api/api_agents.md) — agent CRUD routes.
- [`api_triggers.md`](../api/api_triggers.md) — trigger CRUD and webhook routes.
- [`api_generation.md`](../api/api_generation.md) — LLM generation helpers.
- [`api_mcp.md`](../api/api_mcp.md) — MCP testing route.
- [`engine_native_engine.md`](../reference/engine_native_engine.md) — workflow execution engine.
- [`core_workflow_repo.md`](../reference/core_workflow_repo.md) — workflow persistence and template publishing.
- [`core_mcp_manager.md`](../reference/core_mcp_manager.md) — MCP session/tool management.
- [`services_trigger_scheduler.md`](../workers/services_trigger_scheduler.md) — APScheduler-based trigger dispatch.
...
- **Native engine** — casts raw node dicts to typed node models (`AgentNode`, `ConditionNode`, etc.) before execution. See [engine_native_engine.md](../reference/engine_native_engine.md).
- **Trigger scheduler** — translates `TriggerSchedule` into APScheduler jobs and writes `TriggerExecutionOut` records. See [services_trigger_scheduler.md](../workers/services_trigger_scheduler.md).
- **MCP manager** — uses `McpServerType` and `McpNode.config` to discover and invoke tools. See [core_mcp_manager.md](../reference/core_mcp_manager.md).
- **Authentication** — routes in `api_deps` and across the backend can depend on `require_framework_access("agent-chain")` to receive an `AuthenticatedUser`. See [api_deps.md](../api/api_deps.md) and [auth/dependencies.py](../auth_dependencies.md) in `shared_core`.
