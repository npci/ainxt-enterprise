...
|--------|----------|---------|
| [`budget_router`](../api/shared_api_routers.md) | `GET /budget/team` | Team roster + aggregates |
| [`budget_router`](../api/shared_api_routers.md) | `GET /budget/team/utilization` | Team utilisation breakdown |
| [`budget_router`](../api/shared_api_routers.md) | `GET /budget/users/{id}/usage` | Per-member usage details |
...
- [`shared_api_routers.md`](../api/shared_api_routers.md) — Backend `budget_router` endpoints (`/budget/team`, `/budget/team/utilization`).
