...
**Dependencies:**
- [core.model_registry](../reference/shared_core.md#model_routing) for canonical model constants.
...
- [auth.jwt_handler](../security/authentication.md) for Veo user claim resolution.
...
- [auth.rbac](../security/authentication.md)
...
**Dependencies:**
- [models.hybrid_retriever](../reference/shared_core.md#model_routing)
...
|-----------------|--------|-------|
| LLM model registry | [core.model_registry](../reference/shared_core.md#model_routing) | Canonical model IDs and display labels. |
...
| Hybrid retriever | [models.hybrid_retriever](../reference/shared_core.md#model_routing) | Codebase semantic search. |
| PostgreSQL | [db.database](../storage/database.md) | Security scan storage. |
| Auth / RBAC | [auth.rbac](../security/authentication.md), [auth.jwt_handler](../security/authentication.md) | Admin checks and claim resolution. |
| Telemetry | [core.telemetry](../reference/shared_core.md#core_infrastructure) | Usage and latency metrics. |
...
- [shared_core model_routing](../reference/shared_core.md#model_routing) — Model registry and hybrid retriever.
- [database](../storage/database.md) — PostgreSQL schema and session management.
- [authentication](../security/authentication.md) — RBAC and JWT handling.
