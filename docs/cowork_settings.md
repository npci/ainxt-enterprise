...
|--------|--------|---------|
| `authFetch`, `API_BASE` | [config.md](config.md) | Authenticated HTTP client and API base URL. |
...
|----------------|---------------|----------------|
| `routers/cowork_admin_router.py` | [shared_api_routers.md](shared_api_routers.md) | Role CRUD, approval workflow, preferences. |
| `routers/connectors_router.py` | [shared_api_routers.md](shared_api_routers.md) | Connector definitions and user permissions. |
| `routers/skills_router.py` | [shared_api_routers.md](shared_api_routers.md) | Skill listing for role builder. |
| `services/cowork_roles.py` | [shared_core.md](shared_core.md) | Role persistence and governance logic. |
| `memory/cowork_memory.py` | [shared_core.md](shared_core.md) | User preference storage. |
...
| `CoworkScheduler` | [cowork_scheduler.md](cowork_scheduler.md) | Scheduled tasks respect auto-allow permissions configured here. |
| `AuthContext` | [auth.md](auth.md) | Supplies the `user` object (role, department, approval rights). |
