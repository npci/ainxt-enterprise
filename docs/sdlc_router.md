...
The router is consumed by the [`SDLCPipeline`](sdlc_pipeline.md) component in the `ai-ui` frontend, which provides:
...
- **Governance review panel** ([`GovernanceReviewPanel`](sdlc_governance_review.md)) with author triage board and team approval board
- **Planning artifact view** ([`PlanningArtifactView`](sdlc_planning_artifact.md)) showing the PLAN stage output
- **Pipeline stepper** ([`PipelineStepper`](sdlc_pipeline_stepper.md)) rendering the stage manifest
...
- [shared_core_sdlc_pipeline](shared_core_sdlc_pipeline.md) — Pipeline engine, state machine, and governance engine
- [sdlc_pipeline](sdlc_pipeline.md) — Frontend SDLCPipeline component
- [sdlc_governance_review](sdlc_governance_review.md) — Frontend governance review panel
- [sdlc_planning_artifact](sdlc_planning_artifact.md) — Frontend planning artifact view
- [sdlc_pipeline_stepper](sdlc_pipeline_stepper.md) — Frontend pipeline stage stepper
- [sdlc_gate_signal](sdlc_gate_signal.md) — Frontend gate signal indicators
- [sdlc_status_model](sdlc_status_model.md) — Frontend status label/badge model
- [authentication](authentication.md) — Auth dependencies and RBAC
- [core_infrastructure](core_infrastructure.md) — Job queue, config, logger
- [store_layer](store_layer.md) — sdlc_store, sdlc_artifacts, governance stores
