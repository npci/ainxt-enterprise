...
See also: [chat_router.md](chat_router.md), [gateway.md](gateway.md)
...
See also: [core_governance.md](core_governance.md)
...
See also: [embedding_service.md](embedding_service.md), [knowledge_graph_worker.md](knowledge_graph_worker.md)
...
See also: [threads_router.md](threads_router.md)
...
See also: [sdlc_worker.md](sdlc_worker.md), [sdlc_router.md](sdlc_router.md)
...
See also: [budget_router.md](budget_router.md)
...
See also: [agent_worker.md](agent_worker.md), [agents_router.md](agents_router.md)
...
See also: [worker_orchestration.md](worker_orchestration.md)
...
- [gateway.md](gateway.md) — primary producer of chat, metrics, audit, and SDLC events.
- [worker_orchestration.md](worker_orchestration.md) — starts and supervises the consumer.
- [sdlc_worker.md](sdlc_worker.md) — produces SDLC run events.
- [agent_worker.md](agent_worker.md) — produces agent conversation events.
- [chat_router.md](chat_router.md) / [chat_worker.md](chat_worker.md) — produce chat history events.
- [budget_router.md](budget_router.md) — produces budget events.
- [core_telemetry.md](core_telemetry.md) — produces metrics events.
- [embedding_service.md](embedding_service.md) — produces embedding metadata events.
- [threads_router.md](threads_router.md) — produces thread events.
