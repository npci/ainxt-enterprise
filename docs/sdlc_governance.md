...
- **Upstream callers**: [sdlc_pipeline](shared_core_sdlc_pipeline.md), [sdlc_state_machine](shared_core_sdlc_pipeline.md), [sdlc_agent_loop](shared_core_sdlc_pipeline.md), [sdlc_router](shared_api_routers.md), and the front-end [SDLCPipeline](ai_ui_frontend_sdlc_pipeline.md) / [GovernanceReviewPanel](ai_ui_frontend_sdlc_governance_review.md).
...
- [shared_api_routers](shared_api_routers.md) – API surface including `sdlc_router` and `governance_router`.
