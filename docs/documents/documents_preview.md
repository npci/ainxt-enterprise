...
- For presentation-specific generation, the [presenton_lib](../presentation/presenton_lib.md) and [ppt_wizard](../presentation/ppt_wizard.md) modules may provide analogous streaming previews.
...
| [presenton_lib](../presentation/presenton_lib.md) | Library for presentation-specific generation and layout handling. |
| [ppt_wizard](../presentation/ppt_wizard.md) | Presentation wizard UI that may use live preview patterns. |
