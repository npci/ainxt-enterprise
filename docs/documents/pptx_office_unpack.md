...
- [`pptx_add_slide`](../clients/pptx_add_slide.md), [`pptx_clean`](../reference/pptx_clean.md), and [`pptx_thumbnail`](../reference/pptx_thumbnail.md) operate on the unpacked tree to add slides, remove unused assets, or generate thumbnails.
