...
| **Skills** | [skills_feature](../agents/skills_feature.md) | Reusable Python tool functions for agents. |
| **Codebase** | [shared_core_knowledge_base](../knowledge/shared_core_knowledge_base.md) | Repository indexing and semantic retrieval. |
| **Projects** | [projects](../reference/projects.md) | Scoped AI workspaces for teams. |
| **Threads** | [threads](../chat/threads.md) | Team discussions with `@AiNxt` mentions. |
| **Tool Marketplace** | [marketplace_router](../api/marketplace_router.md), [mcp_system](../mcp/mcp_system.md) | MCP tool registry and external tool registration. |
| **Budget** | [budget_router](../api/budget_router.md), [budget_manager](../models/budget_manager.md) | Per-user LLM cost tracking and budget enforcement. |
...
| **Monitoring** | [monitoring](../infrastructure/monitoring.md) | Platform health, circuit breakers, job queues, Prometheus metrics. |
| **Analytics** | [agent_analytics](../agents/agent_analytics.md) | Per-agent performance and cost analytics. |
| **AiNxt Coach** | [coach](../evaluation/coach.md), [coach_evaluator](../coach_evaluator.md) | AI-usage coaching and prompt-practice scoring. |
...
- [skills_feature](../agents/skills_feature.md) — skills dashboard and factory chat.
- [shared_core_knowledge_base](../knowledge/shared_core_knowledge_base.md) — codebase indexing and retrieval.
- [projects](../reference/projects.md) — scoped project workspaces.
- [threads](../chat/threads.md) — threaded team discussions.
- [marketplace_router](../api/marketplace_router.md) — tool marketplace API.
- [mcp_system](../mcp/mcp_system.md) — MCP tool registry.
- [budget_router](../api/budget_router.md) — budget management API.
- [budget_manager](../models/budget_manager.md) — budget UI.
...
- [monitoring](../infrastructure/monitoring.md) — platform monitoring dashboard.
- [agent_analytics](../agents/agent_analytics.md) — agent analytics dashboard.
- [coach](../evaluation/coach.md) — AI-usage coaching UI.
