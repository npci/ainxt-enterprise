...
- **ABStudio backend** — the [`doc_generator`](../reference/shared_integrations.md) tool and document-generation workers use these skills to produce DOCX/PPTX/XLSX artifacts.
