...
- **Shared skills** ([`shared_skills`](../agents/shared_skills.md)) group this module with DOCX, PPTX, PDF, and DSLAR skill families.
...
- [`shared_skills`](../agents/shared_skills.md) – parent module grouping all document skills.
