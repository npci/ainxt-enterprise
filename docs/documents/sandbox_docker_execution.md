...
3. **PCI input/output validation** — block or redact sensitive data using the shared [compliance_engine](../compliance_engine.md).
...
- **Image override support** for repo-specific `ainxt-builder-*` images produced by [sandbox_image_building](../storage/sandbox_image_building.md).
...
| `sandbox.sandbox_image_builder` | Builds repo-specific images used via `image_override`. See [sandbox_image_building](../storage/sandbox_image_building.md). |
| `sandbox.self_healing_engine` | Wraps `DockerExecutor` in a retry/heal loop. See [sandbox_self_healing](../sandbox_self_healing.md). |
...
- [sandbox](../storage/sandbox.md) — parent module overview.
- [sandbox_image_building](../storage/sandbox_image_building.md) — repo-specific sandbox image builder.
- [sandbox_self_healing](../sandbox_self_healing.md) — automatic retry/heal wrapper.
...
- [compliance_engine](../compliance_engine.md) — PCI input/output validation.
