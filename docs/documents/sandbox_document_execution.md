...
| [sandbox_image_building](../storage/sandbox_image_building.md) | Builds per-repo Docker images for SDLC code execution. Not directly used by the document executor, but shares the same Docker-based isolation philosophy. |
