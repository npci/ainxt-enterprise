...
| [CoworkDesktop.jsx](../buddy/cowork_desktop.md) | Full local-agent desktop experience |
| [useDesktop.js](../ui/ai_ui_frontend_hooks.md) | `isCoworkOfficeAvailable` detection |
| [config.js](../infrastructure/config.md) | `API_BASE`, `authFetch` |

### Backend Modules

| Module | Purpose |
|--------|---------|
| [gateway.py](../models/gateway.md) | `POST /ask`, `POST /docs/generate`, `POST /connectors/action`, `POST /chat/upload` |
| [routers/chat_router.py](../api/chat_router.md) | Chat upload and messaging endpoints |
| [routers/doc_download_router.py](../api/doc_download_router.md) | Document generation, status polling, download |
| [routers/connectors_router.py](../api/connectors_router.md) | Connector action execution |
...
| [connectors/engine.py](../reference/shared_integrations.md#connector_infrastructure) | Connector runtime |
...
- [CoworkDesktop](../buddy/cowork_desktop.md) — local-agent desktop mode
- [Gateway](../models/gateway.md) — main API gateway
- [Connectors Router](../api/connectors_router.md) — connector action endpoints
- [Document Download Router](../api/doc_download_router.md) — document generation endpoints
- [Workers](../workers/workers.md) — background job workers
- [Shared Integrations](../reference/shared_integrations.md) — connector adapters and engine
