...
- [native_engine.md](../native_engine.md) — graph walker, HITL pause/resume, loop driver, sub-flow dispatch.
- [services.md](../reference/services.md) — HITL mode parsing, condition DSL, and helper functions.
- [checkpoint.md](../reference/checkpoint.md) — pause snapshots and per-node output persistence.
- [chat.md](../chat/chat.md) — SSE chat endpoint that delivers `hitl_interrupt` events.
- [workflowStore.md](../workflowStore.md) — frontend execution payload and node defaults.
- [ConfigPanel.md](../infrastructure/ConfigPanel.md) — UI editor for HITL mode, loop config, and asset references.
- [AgentRunner.md](../AgentRunner.md) — runner reused when an Existing Asset node dispatches an agent.
...
- **See**: [native_engine.md](../native_engine.md), [services.md](../reference/services.md), [checkpoint.md](../reference/checkpoint.md), [chat.md](../chat/chat.md), [ConfigPanel.md](../infrastructure/ConfigPanel.md).
...
- **See**: [native_engine.md](../native_engine.md), [services.md](../reference/services.md), [workflowStore.md](../workflowStore.md), [ConfigPanel.md](../infrastructure/ConfigPanel.md).
...
- **See**: [native_engine.md](../native_engine.md), [AgentRunner.md](../AgentRunner.md), [workflowStore.md](../workflowStore.md), [SubflowNode.md](../SubflowNode.md).
...
- [workflowStore.md](../workflowStore.md)
- [ConfigPanel.md](../infrastructure/ConfigPanel.md)
- [LoopItemsPicker.md](../ui/LoopItemsPicker.md)
- [SubflowNode.md](../SubflowNode.md)
- [AgentRunner.md](../AgentRunner.md)
