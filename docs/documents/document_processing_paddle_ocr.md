...
| document_processing_legacy_parser | Fallback — used when Docling/PaddleOCR is unavailable or fails |
| [core_infrastructure](../core/core_infrastructure.md) | Provides `core.logger` used for structured logging |
...
| Legacy document parser (fallback path) | document_processing_legacy_parser |
| Document processing overview | [document_processing](document_processing.md) |
| Core infrastructure (logger, config) | [core_infrastructure](../core/core_infrastructure.md) |
