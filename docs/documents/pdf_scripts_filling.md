...
- [pdf_skills_filling.md](../agents/pdf_skills_filling.md) — The ABStudio/Anthropic PDF filling counterpart.
- [docskills_legacy.md](../agents/docskills_legacy.md) — Overview of the legacy DocSkills document toolkit.
- [shared_skills.md](../agents/shared_skills.md) — Broader skill ecosystem including docx, pptx, xlsx, and PDF skills.
