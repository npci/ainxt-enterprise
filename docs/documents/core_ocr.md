...
- **Document parsing:** Delegates structured-file and vision parsing to the parent platform's [`document_processing`](../core/shared_core.md#document_processing) components (`core.document_parser`).
- **PDF OCR:** Delegates scanned-PDF handling to the parent platform's [`document_processing`](../core/shared_core.md#document_processing) components (`core.pdf_ocr`).
