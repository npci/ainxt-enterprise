...
- **REST API calls** from the [sdlc_router](../api/shared_api_routers.md) (manual triggers, approvals, resumes)
- **GitLab MR webhooks** (PR review pipeline)

It delegates to the [shared_core_sdlc_pipeline](../sdlc/shared_core_sdlc_pipeline.md) sub-modules for the state machine, CLI engine, governance engine, and patch engine, and persists all state through the [store_layer](../storage/store_layer.md).
...
The SDLC pipeline is exposed through the [sdlc_router](../api/shared_api_routers.md) with endpoints including:
...
| [store_layer](../storage/store_layer.md) | Persistence: `sdlc_store`, `sdlc_artifacts`, `sdlc_governance_findings`, `sdlc_governance_approvers`, `inbox_store` |
| [shared_api_routers](../api/shared_api_routers.md) | REST API surface (`sdlc_router.py`) |
| [sdlc_pipeline_workers](../workers/sdlc_pipeline_workers.md) | RQ worker entry points |
| [core_infrastructure](../infrastructure/core_infrastructure.md) | Logger, telemetry, config, circuit breaker, security validation |
...
- [sdlc_pipeline_workers](../workers/sdlc_pipeline_workers.md) — RQ worker job definitions
- [shared_api_routers](../api/shared_api_routers.md) — REST API router documentation
- [store_layer](../storage/store_layer.md) — Persistence layer documentation
- [sdlc_pipeline](../sdlc/sdlc_pipeline.md) — Frontend UI component documentation
- [core_infrastructure](../infrastructure/core_infrastructure.md) — Logging, telemetry, and configuration
