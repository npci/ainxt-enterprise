...
- **[core_config](../core/core_config.md)** — `factory_model`, `fill_blank_llm_fields`, `openai_compatible_base_url`, `openai_compatible_api_key` for resolving the judge's LLM endpoint.
- **[core_llm_handler](../llm/core_llm_handler.md)** — `Message`, `get_llm_client` for provider-agnostic LLM calls (OpenAI / Ollama / vLLM / LiteLLM).
- **[app_models](../core/app_models.md)** — `LLMConfig` dataclass for constructing the LLM client.
...
- [core_config](../core/core_config.md) — `factory_model`, `fill_blank_llm_fields`, `openai_compatible_*` helpers
- [core_llm_handler](../llm/core_llm_handler.md) — `Message`, `get_llm_client`, `FallbackLLMClient`
- [app_models](../core/app_models.md) — `LLMConfig` dataclass
