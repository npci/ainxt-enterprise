...
| `triggers_feature` ([triggers_feature.md](../ui/triggers_feature.md)) | Trigger creation and execution history | Dashboard opens `TriggerModal` for a selected agent. |
...
- **Triggers** ([api_triggers.md](../api/api_triggers.md) / [triggers_feature.md](../ui/triggers_feature.md)): Allows agents to run on schedules or webhooks.
