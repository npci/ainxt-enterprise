...
> **Related modules:** [agent_factory_pipeline](agent_factory_pipeline.md) · [api_factories](../api/api_factories.md) · [api_catalog](../api/api_catalog.md) · [core_factory_utils](../reference/core_factory_utils.md) · [core_workflow_repo](../reference/core_workflow_repo.md) · [core_governance](../sdlc/core_governance.md) · [workflow_factory_pipeline](../workflows/workflow_factory_pipeline.md) · [skills_feature](skills_feature.md)
...
Every LLM call in the pipeline routes through `call_factory_llm` in [core_factory_utils](../reference/core_factory_utils.md), which:
