...
- **Skill packaging** — The scripts can be packaged as reusable skills via the ABStudio skill factory.
...
- [doc_generator.md](../documents/doc_generator.md) â€” Higher-level document generation tools.
