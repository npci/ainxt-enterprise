...
- **Auth**: All requests use `authFetch` from [`config.md`](../infrastructure/config.md), which attaches correlation IDs and credentials.
- **Time formatting**: Live logs use `toIST` from [`time.md`](../time.md).
...
| Dependency | Purpose |
|------------|---------|
| [`config.md`](../infrastructure/config.md) | `authFetch`, `API_BASE` |
| [`time.md`](../time.md) | `toIST` for IST timestamp formatting |
...
The Agent Analytics module is part of the [`ai_ui_frontend`](../ui/ai_ui_frontend.md) analytics surface. It consumes data produced by:

- The gateway's analytics and metrics endpoints (see [`gateway.md`](../models/gateway.md)).
- The agent management surface (see [`agents_catalog.md`](agents_catalog.md)).
- The LLM spend reporting subsystem (see [`llm_spend_report_router.md`](../api/llm_spend_report_router.md)).
...
- [`ai_ui_frontend.md`](../ui/ai_ui_frontend.md) — parent frontend module
- [`config.md`](../infrastructure/config.md) — `authFetch` and API base configuration
- [`time.md`](../time.md) — IST timestamp formatting
- [`gateway.md`](../models/gateway.md) — backend gateway providing `/metrics` and analytics
- [`agents_catalog.md`](agents_catalog.md) — agent catalog and related UI
- [`llm_spend_report_router.md`](../api/llm_spend_report_router.md) — cloud spend backfill API
