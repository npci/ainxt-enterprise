...
It is also related to the higher-level [`doc_generator`](../reference/shared_integrations.md) and [`presenton_lib`](../ui/ai_ui_frontend.md) components that produce `.pptx` artifacts, where thumbnail previews can aid in content review and cataloging.
