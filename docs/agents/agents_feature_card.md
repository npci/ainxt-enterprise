...
| [hooks](../ui/hooks.md) `useHoverTooltip` | Manages tooltip visibility, anchor bindings, and unique ID. |
| [utils](../ui/utils.md) `formatDate` | Formats `updated_at` for display. |
| [utils](../ui/utils.md) `stripProviderPrefix` | Cleans the model name label (e.g., removes provider prefix). |
| [utils](../ui/utils.md) `stripTemplateTag` | Removes template markers from the description text. |
...
- [hooks](../ui/hooks.md) — shared React hooks (`useHoverTooltip`).
- [utils](../ui/utils.md) — formatting and text utilities used by the card.
