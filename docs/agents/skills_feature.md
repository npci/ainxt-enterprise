...
|------------|---------|---------------|
| `FactoryChatShell` | Shared modal chat container | [shared_features.md](../reference/shared_features.md) |
| `useFactoryChatStream` | Streaming chat state management | [shared_features.md](../reference/shared_features.md) |
| `PlanCard` | Clarifying-question card UI | [common_components.md](../ui/common_components.md) |
| `HoverTooltip` / `useHoverTooltip` | Accessible hover tooltips | [common_components.md](../ui/common_components.md), [hooks.md](../reference/hooks.md) |
...
- [shared_features.md](../reference/shared_features.md) — shared factory chat shell and streaming hook.
