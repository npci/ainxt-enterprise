...
| [core_llm_handler](../llm/core_llm_handler.md) | `FallbackLLMClient`, `OpenAIClient`, `Message` for LLM communication |
| [core_mcp_manager](../mcp/core_mcp_manager.md) | `McpSessionManager` for MCP tool resolution |
| [core_workflow_repo](../workflows/core_workflow_repo.md) | `get_tool()`, `get_skill()`, `list_skill_files()` for catalog lookups |
...
| [app_models](../core/app_models.md) | `Workflow`, `RunRequest`, `ResumeRequest` data models |
