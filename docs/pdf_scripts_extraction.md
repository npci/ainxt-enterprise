...
- [`pdf_skills_extraction`](pdf_skills_extraction.md): newer Anthropic skill implementation of the same extraction concepts.
- [`docskills_legacy`](docskills_legacy.md): parent module containing legacy docx, pptx, xlsx, and PDF skills.
...
- It mirrors the newer `ABStudio/skills/ainxt-skills/pdf/scripts/extract_form_field_info.py` and `extract_form_structure.py` under [`pdf_skills_extraction`](pdf_skills_extraction.md).
