...
For higher-level orchestration of these flows, see [agent_system](agent_system.md), [shared_core_sdlc_pipeline](shared_core_sdlc_pipeline.md), and [workflow_system](workflow_system.md).
...
- [shared_core_sdlc_pipeline](shared_core_sdlc_pipeline.md) — SDLC coding loop consumer.
