...
The connectors router exposes two DPI-specific endpoints. These are documented in `shared_api_routers_connectors_router.md`:
...
- `shared_api_routers_connectors_router.md` — REST endpoints for connector management and DPI consent.
