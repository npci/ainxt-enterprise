...
|------------|---------|---------------|
| `FactoryChatShell` | Shared modal chat container | [shared_features.md](../core/shared_features.md) |
| `useFactoryChatStream` | Streaming chat state management | [shared_features.md](../core/shared_features.md) |
| `PlanCard` | Clarifying-question card UI | [common_components.md](../ui/common_components.md) |
| `HoverTooltip` / `useHoverTooltip` | Accessible hover tooltips | [common_components.md](../ui/common_components.md), [hooks.md](../ui/hooks.md) |
| `StatusBadge` | Governance status display | [governance_feature.md](../sdlc/governance_feature.md) |
| `SubmitApprovalButton` | Governance submission action | [governance_feature.md](../sdlc/governance_feature.md) |
...
- [agents_feature.md](../agents/agents_feature.md) — agents consume skills from the catalog.
- [workflows_feature.md](../workflows/workflows_feature.md) — workflows can invoke skills at specific nodes.
- [governance_feature.md](../sdlc/governance_feature.md) — approval lifecycle for AI-generated skills.
- [shared_features.md](../core/shared_features.md) — shared factory chat shell and streaming hook.
- [common_components.md](../ui/common_components.md) — reusable UI primitives such as `PlanCard` and `HoverTooltip`.
- [api_catalog.md](../api/api_catalog.md) — backend catalog API that powers this frontend.
