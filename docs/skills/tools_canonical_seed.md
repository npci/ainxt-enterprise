...
[`core_workflow_repo`](../workflows/core_workflow_repo.md). The module is intentionally
...
The `service` value is used by [`api_catalog`](../api/api_catalog.md) to filter the
public catalog and by the [`engine_native_engine`](../agents/engine_native_engine.md)
...
[`api_catalog`](../api/api_catalog.md) exposes endpoints such as
...
[`engine_native_engine`](../agents/engine_native_engine.md) resolves agent-attached
...
- [`tools_m365_bridge`](../connectors/tools_m365_bridge.md) — Microsoft 365 connector-bridge
  shims.
- [`tools_swarm_spawn`](../agents/tools_swarm_spawn.md) — synthetic `spawn_swarm` tool
...
[`core_workflow_repo`](../workflows/core_workflow_repo.md) provides the persistence
