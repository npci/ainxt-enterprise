...
4. Agents in [`agent_factory_pipeline`](../agents/agent_factory_pipeline.md) or [`agent_system`](../core/shared_core.md#agent_system) can compose these tools into larger recruiting workflows.
