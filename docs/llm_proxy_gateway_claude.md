...
- **Does NOT manage conversation persistence.** Chat history, thread state, and checkpointing are handled by [`abstudio_backend`](abstudio_backend.md) and [`shared_core_memory_system`](shared_core_memory_system.md).
