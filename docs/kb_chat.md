...
It is the KB-specific counterpart to the general-purpose [chat](chat.md) module and reuses the same authentication, messaging, and notification infrastructure while adding KB-aware behaviour such as RAG-mode toggling, attachment handling, and document-generation intent detection.
...
- [ppt_detection](ppt_detection.md) — document-generation intent and format detection.
- [chat](chat.md) — general-purpose chat counterpart.
- [config](config.md) — `authFetch` and API base configuration.
- [auth](auth.md) — authentication context.
- [ui_dialog](ui_dialog.md) — toast and confirm providers.
- [chat_router](chat_router.md) — backend chat, upload, share, and prompt-template endpoints.
- [feedback_router](feedback_router.md) — backend message-feedback endpoint.
- [doc_download_router](doc_download_router.md) — generic document generation backend.
- [presenton_router](presenton_router.md) — presentation-generation backend.
- [presenton_lib](presenton_lib.md) — frontend presentation-generation library.
- [ppt_wizard](ppt_wizard.md) — PowerPoint creation wizard UI.
- [documents](documents.md) — generic document cards and preview components.
