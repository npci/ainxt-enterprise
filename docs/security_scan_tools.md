...
- **[secure_code_gate_router](secure_code_gate_router.md)** exposes the secure code gate as a synchronous HTTP endpoint.
...
- [secure_code_gate_router](secure_code_gate_router.md) – HTTP router for the secure code gate.
