...
| `core.config` | Redis host/port/password and other environment settings. | [core_config](core_config.md) |
...
| [cowork_scheduler](cowork_scheduler.md) | Worker that fires scheduled Cowork tasks. |
...
For details on the desktop side of the dispatch flow, see [desktop_app](desktop_app.md). For scheduled/headless Cowork execution, see [cowork_tasks_router](cowork_tasks_router.md) and [cowork_task_worker](cowork_task_worker.md).
