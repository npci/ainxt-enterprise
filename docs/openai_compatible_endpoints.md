...
- [chat_and_messaging](chat_and_messaging.md) — The platform's primary `/ask` streaming endpoint and chat history persistence
...
- [messages_compat_router](messages_compat_router.md) — Anthropic Messages API compatibility endpoint
- [endpoint_proxy_router](endpoint_proxy_router.md) — Managed endpoint proxy for per-team OpenAI-compatible endpoints
