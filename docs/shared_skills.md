...
4. **Skill authoring tooling** — Evaluate, optimize, package, and review Claude Code skills locally.
...
flowchart TB
    ...
    CREATOR --> CREATOR_MOD["skill_creator_tools"]
...
graph LR
    ...
    Agent -->|invokes| skill_creator_tools
...
| `skill_creator_tools` | Local developer toolkit for evaluating, optimizing, packaging, and reviewing Claude Code skills. | [skill_creator_tools](skill_creator_tools.md) |
| `docskills_legacy` | Legacy Anthropic document-skills toolkit covering DOCX/PPTX/XLSX round-trips and PDF form filling. | [docskills_legacy](docskills_legacy.md) |
...
- **Skill catalog / marketplace** — Packaged skills produced by `skill_creator_tools` can be uploaded through the catalog and marketplace APIs.
