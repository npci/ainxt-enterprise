...
- [app_core.md](../reference/app_core.md) — SPA routing and `PORTAL_BASE` consumption.
- [chat.md](../chat/chat.md) — `authFetch` usage in the main chat feature.
- [kb_chat.md](../knowledge/kb_chat.md) — `authFetch` usage in knowledge-base chat.
- [agents_catalog.md](../agents/agents_catalog.md) — agent catalog network calls.
- [presenton_lib.md](../reference/presenton_lib.md) — Presenton API client and `presentonFetch` usage.
- [gateway.md](../models/gateway.md) — FastAPI gateway that handles `/ainxt/v1/api` traffic.
