...
| `logger` | [core_infrastructure](../core/core_infrastructure.md) | Structured logging for all strategy lifecycle events (start, depth progression, scoring, verification results, errors). |
...
- **[model_routing](model_routing.md)** — The `ModelRouter` handles all LLM
  ...
  the router selects.
- **[core_infrastructure](../core/core_infrastructure.md)** — Provides the `logger`
