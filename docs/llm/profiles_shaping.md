...
- Policy resolution → profiles_resolver.md
- Profile schema → [profiles_schema.md](profiles_schema.md)
- Turn-level risk/sensitivity/tool policy → [cil_policy.md](../security/cil_policy.md)
...
1. The **CIL pipeline** extracts per-turn signals such as expertise level, emotional tone, and explicit style requests (e.g., "explain like I'm five"). See [cil_policy.md](../security/cil_policy.md) and [cil_lexical.md](../security/cil_lexical.md).
2. The **profile resolver** supplies platform/organization defaults. See profiles_resolver.md.
...
- profiles_resolver.md resolves the effective policy and passes profile-level values into shaping.
- [cil_policy.md](../security/cil_policy.md) and [cil_lexical.md](../security/cil_lexical.md) produce the per-turn signals.
...
| `profiles/resolver.py` | profiles_resolver.md | Resolves the effective policy that feeds `profile_tone` and `profile_style`. |
...
| `cil/policy.py` | [cil_policy.md](../security/cil_policy.md) | Produces per-turn `derive_policy` outputs that may include style/expertise signals. |
| `cil/lexical.py` | [cil_lexical.md](../security/cil_lexical.md) | Cheap lexical detectors for expertise, emotional tone, and output format hints. |
...
- profiles_resolver.md
- [profiles_routing.md](profiles_routing.md)
- [cil_policy.md](../security/cil_policy.md)
- [cil_lexical.md](../security/cil_lexical.md)
