...
- For the CIL policy derivation that consumes profiles, see [`cil_policy.md`](../security/cil_policy.md).
- For the model router that enforces the privacy floor, see `model_router.md`.
