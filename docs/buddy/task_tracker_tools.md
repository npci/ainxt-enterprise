...
- **[shared_integrations](../reference/shared_integrations.md)** — Sibling tool modules (e.g., [jira_tools](../reference/shared_integrations.md#jira_tools), [calendar_tools](../reference/shared_integrations.md#calendar_tools)) follow the same pattern and may be composed with task tracker tools in workflows.
...
`task_tracker_tools` is one of many tool modules in the [shared_integrations](../reference/shared_integrations.md) layer. It is designed to be:

- **Composable**: Agents can chain `create_task` with [email_tools](../reference/shared_integrations.md#email_tools) to send notifications, or with [calendar_tools](../reference/shared_integrations.md#calendar_tools) to schedule follow-ups.
...
- **Governable**: `create_task` and `update_task` are flagged for PCI audit in the MCP server, aligning with platform governance requirements. See [mcp_servers](../mcp/mcp_servers.md) and [core_governance](../reference/shared_core.md#core_governance) for audit handling.

In the [abstudio_backend](../ui/abstudio_backend.md), task tracker tools may be surfaced through the catalog API and referenced by agents or workflows built in the studio. Refer to [api_catalog](../ui/abstudio_backend.md#api_catalog) and [agent_factory_pipeline](../ui/abstudio_backend.md#agent_factory_pipeline) for how tools are discovered and bound to agents.
...
- [shared_integrations](../reference/shared_integrations.md) — Sibling tool modules and integration patterns.
- [abstudio_backend](../ui/abstudio_backend.md) — Backend APIs for catalog, agents, and workflows.
