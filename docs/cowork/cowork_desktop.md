...
| File upload | `/chat/upload` | [chat_router](../chat/chat_router.md) |
| Document fallback | `/docs/generate` | [doc_download_router](../documents/doc_download_router.md) |
| Model governance | `/model-governance/my-models`, `/cowork/model-config` | [model_governance_router](../llm/model_governance_router.md) |
...
- [chat_router](../chat/chat_router.md) — chat/file upload backend endpoints.
- [doc_download_router](../documents/doc_download_router.md) — document generation fallback endpoints.
- [model_governance_router](../llm/model_governance_router.md) — model allow-list and lock configuration.
