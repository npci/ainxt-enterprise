...
| `CoworkMemory` | [memory_system](../storage/memory_system.md) | Postgres-backed per-user preference and note store |
...
- [memory_system](../storage/memory_system.md) — `CoworkMemory` and the broader memory service
