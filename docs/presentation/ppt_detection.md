...
For details on the surrounding chat logic, see [kb_chat.md](../knowledge/kb_chat.md). For the presentation-generation stack, see [presenton_lib.md](presenton_lib.md) and [ppt_wizard.md](ppt_wizard.md).
...
- [kb_chat.md](../knowledge/kb_chat.md) — Parent chat component that hosts the detection helpers.
...
- [documents.md](../documents/documents.md) — Generic document generation and preview components.
- [chat.md](../chat/chat.md) — Main chat component in the AI UI for non-KB conversations.
