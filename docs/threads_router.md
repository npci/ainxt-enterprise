...
The SDLC pipeline is documented in detail in [shared_core_sdlc_pipeline](shared_core_sdlc_pipeline.md).
...
|------------|--------|----------------|
| `store.threads_store` | shared_core → store_layer | [store_layer](store_layer.md) |
| `store.inbox_store` | shared_core → store_layer | [store_layer](store_layer.md) |
| `store.sdlc_store` | shared_core → store_layer | [store_layer](store_layer.md) |
| `agents.react_engine` | shared_core → agent_system → reaction_engines | [agent_system](agent_system.md) |
| `agents.sdlc_pipeline` | shared_core → shared_core_sdlc_pipeline | [shared_core_sdlc_pipeline](shared_core_sdlc_pipeline.md) |
| `models.model_router` | shared_core → model_routing | [model_routing](model_routing.md) |
| `models.hybrid_retriever` | shared_core → model_routing | [model_routing](model_routing.md) |
| `core.security_validation` | shared_core → core_infrastructure | [core_infrastructure](core_infrastructure.md) |
| `core.kafka_producer` | shared_core → core_infrastructure | [core_infrastructure](core_infrastructure.md) |
| `core.job_queue` | shared_core → core_infrastructure | [core_infrastructure](core_infrastructure.md) |
| `core.kv` | shared_core → kv_store | [kv_store](kv_store.md) |
| `auth.dependencies` / `auth.rbac` | shared_core → authentication | [authentication](authentication.md) |
| `tools.jira_tools` | shared_integrations | [shared_integrations](shared_integrations.md) |
| `tools.gitlab_tools` | shared_integrations | [shared_integrations](shared_integrations.md) |
| `db.database` / `db.models` | shared_core → database | [database](database.md) |
| Kafka consumer (`_handle_thread_events`) | workers → kafka_event_consumer | [kafka_event_consumer](kafka_event_consumer.md) |
| SDLC workers | workers → sdlc_pipeline_workers | [sdlc_pipeline_workers](sdlc_pipeline_workers.md) |
