...
Both endpoints are part of the backend Teams router (`routers/teams_router.py`). See [teams_router.md](../api/teams_router.md) for endpoint details.
...
|--------|----------------|------|
| `routers/teams_router.py` | Exposes `/teams/config`, `/teams/metrics`, `/teams/messages`, `/teams/notify`, `/teams/health`. | [teams_router.md](../api/teams_router.md) |
...
| `gateway.py` | Mounts the Teams SDK webhook during startup (`_mount_teams_sdk`). | [gateway.md](../models/gateway.md) |
...
- [teams_router.md](../api/teams_router.md) — Backend Teams REST endpoints.
...
- [gateway.md](../models/gateway.md) — Service startup and Teams SDK mounting.
