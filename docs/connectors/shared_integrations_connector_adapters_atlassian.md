...
| [LLM Proxy `atlassian_proxy`](../models/llm_proxy_main.md) | Production egress relay for Jira calls (reachable only from `web02`) |
...
- [llm_proxy_main](../models/llm_proxy_main.md) — LLM proxy service including the `atlassian_proxy` endpoint
