...
> **See also:** [shared_core.md](../core/shared_core.md) for the `CircuitBreaker` implementation details (CLOSED → OPEN → HALF_OPEN state machine with Redis-backed persistence).
...
> **See also:** [shared_core_sdlc_pipeline.md](../sdlc/shared_core_sdlc_pipeline.md) for the full SDLC pipeline architecture.
...
> **See also:** [mcp_servers.md](../mcp/mcp_servers.md) for the MCP server framework and transport details.
...
> **See also:** [shared_integrations_connector_adapters.md](../skills/shared_integrations_connector_adapters.md) for the connector adapter framework.
...
> **See also:** [shared_core_sdlc_pipeline.md](../sdlc/shared_core_sdlc_pipeline.md) for governance engine details.
...
> **See also:** [shared_api_routers.md](../core/shared_api_routers.md) for the webhook router.
