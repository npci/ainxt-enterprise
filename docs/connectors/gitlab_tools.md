...
> **See also:** [shared_core.md](../reference/shared_core.md) for the `CircuitBreaker` implementation details (CLOSED → OPEN → HALF_OPEN state machine with Redis-backed persistence).
...
> **See also:** [shared_api_routers.md](../api/shared_api_routers.md) for the webhook router.
