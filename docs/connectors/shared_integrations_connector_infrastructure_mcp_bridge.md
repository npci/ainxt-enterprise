...
graph TB
    ...
    subgraph PlatformServices["Platform Services"]
        ...
        DocSkills["Anthropic Doc Skills<br/>docx/pptx/xlsx/pdf"]
    end
...
> See [shared_core_agent_system](../shared_core_agent_system.md) for full
...
> See [shared_core_memory_system](../shared_core_memory_system.md) for CoworkMemory
> documentation.
...
| `ComplianceEngine` | [shared_core_agent_system](../shared_core_agent_system.md) | PAN/PII/secret detection, redaction, blocking |
| `CoworkMemory` | [shared_core_memory_system](../shared_core_memory_system.md) | Durable agent-remembered facts |
| `job_queue` (RQ) | [shared_core_core_infrastructure](../shared_core_core_infrastructure.md) | Async doc/code job enqueue |
| `docker_executor` | [shared_core_sandbox](../shared_core_sandbox.md) | Isolated code execution |
| `model_router` | [shared_core_model_routing](../shared_core_model_routing.md) | Multi-vendor LLM dispatch |
| `cowork_mcp_router` | [shared_api_routers](../api/shared_api_routers.md) | SSE/HTTP transport, session routing |
| Anthropic doc skills | [shared_skills](../agents/shared_skills.md) | SKILL.md files for docx/pptx/xlsx/pdf |
