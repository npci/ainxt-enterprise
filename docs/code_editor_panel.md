...
| Module | Relationship |
| --- | --- |
| [code](code.md) | Parent page that owns IDE state and renders `FileEditorPanel`. |
...
| [ai_ui_frontend_hooks](ai_ui_frontend_hooks.md) | `useDesktop.js` exposes `readFile` and `writeFile` desktop IPC helpers. |
