...
- [feedback_and_sharing](../chat/feedback_and_sharing.md) — message feedback submission and public chat sharing.
- [config](../core/config.md) — `authFetch` and API base configuration.
- [chat_router](../chat/chat_router.md) — backend chat and share endpoints.
