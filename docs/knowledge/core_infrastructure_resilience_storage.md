...
> [core_infrastructure](../infrastructure/core_infrastructure.md). See also
...
> [core_infrastructure_security](../core_infrastructure_security.md), and
...
> See [core_infrastructure_config_logging](../infrastructure/core_infrastructure_config_logging.md)
...
[admin_router](../api/shared_api_routers.md) module:
...
`circuit_breaker_health` (see [gateway health_and_monitoring](../models/gateway.md)).
...
[core_infrastructure_config_logging](../infrastructure/core_infrastructure_config_logging.md) for
...
The `RateLimitMiddleware` (see [middleware](../reference/middleware.md)) calls
...
See [gateway health_and_monitoring](../models/gateway.md) for details.
...
|---|---|---|---|
| `core.logger` | All four components | Structured logging | [core_infrastructure_config_logging](../infrastructure/core_infrastructure_config_logging.md) |
| `core.config.RDB_QUEUE` | `CircuitBreaker`, `DistributedSemaphore` | KV DB=5 for shared state | [core_infrastructure_config_logging](../infrastructure/core_infrastructure_config_logging.md) |
| `core.config.redis_client()` | `RateLimitConfig` | Direct Redis client for DB=7 | [core_infrastructure_config_logging](../infrastructure/core_infrastructure_config_logging.md) |
...
| `metrics.py` | `RateLimitConfig` | Prometheus `rate_limit_exceeded_total` counter | [core_infrastructure_observability](../infrastructure/core_infrastructure_observability.md) |
...
| Topic | Reference |
|---|---|
| Central configuration & logging | [core_infrastructure_config_logging](../infrastructure/core_infrastructure_config_logging.md) |
| Telemetry, tracing, Prometheus metrics | [core_infrastructure_observability](../infrastructure/core_infrastructure_observability.md) |
| Prompt injection, security validation, RAG ACL | [core_infrastructure_security](../core_infrastructure_security.md) |
| KV layer (Redis abstraction) | [kv_store](../storage/kv_store.md) |
| Middleware (rate-limit, budget, request-id) | [middleware](../reference/middleware.md) |
| Gateway health & monitoring endpoints | [gateway](../models/gateway.md) |
| Admin router (circuit-breaker management) | [shared_api_routers](../api/shared_api_routers.md) |
| Parent core infrastructure module | [core_infrastructure](../infrastructure/core_infrastructure.md) |
