...
|---|---|---|
| `hooks` (`useFileDrop`) | Drag-and-drop file handling with ref-callback pattern for lazy-mounted drop zones | [hooks](../ui/hooks.md) |
| `config` | `authFetch` (cookie-auth + retry on GET), `API_BASE` | [config](../core/config.md) |
