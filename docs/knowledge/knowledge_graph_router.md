...
- **Authentication**: All routes depend on `auth.dependencies.get_current_user` (see [auth_router](../auth/auth_router.md) and [auth dependencies](../core/shared_core.md#authentication)).
- **Job queue**: `build_graph` uses `core.job_queue.enqueue_job` with `Q_KB` to schedule asynchronous work (see [core infrastructure](../core/shared_core.md#core-infrastructure)).
...
- [auth dependencies](../core/shared_core.md#authentication) - user authentication and JWT context.
- [core logger](../core/shared_core.md#core-infrastructure) - structured logging.
- [core job queue](../core/shared_core.md#core-infrastructure) - asynchronous job enqueueing.
- [db database](../core/shared_core.md#database) - SQLAlchemy session management.
...
- [store kb_entity_registry](../core/shared_core.md#shared-core-knowledge-base) - canonical entity resolution.
