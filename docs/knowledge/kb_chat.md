...
- [ppt_detection](../reference/ppt_detection.md) — document-generation intent and format detection.
- [chat](../chat/chat.md) — general-purpose chat counterpart.
- [config](../infrastructure/config.md) — `authFetch` and API base configuration.
- [auth](../security/auth.md) — authentication context.
- [ui_dialog](../ui/ui_dialog.md) — toast and confirm providers.
- [chat_router](../api/chat_router.md) — backend chat, upload, share, and prompt-template endpoints.
- [feedback_router](../api/feedback_router.md) — backend message-feedback endpoint.
- [doc_download_router](../api/doc_download_router.md) — generic document generation backend.
- [presenton_router](../api/presenton_router.md) — presentation-generation backend.
- [presenton_lib](../reference/presenton_lib.md) — frontend presentation-generation library.
- [ppt_wizard](../reference/ppt_wizard.md) — PowerPoint creation wizard UI.
