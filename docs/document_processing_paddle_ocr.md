...
| [core_infrastructure](core_infrastructure.md) | Provides `core.logger` used for structured logging |
...
| Core infrastructure (logger, config) | [core_infrastructure](core_infrastructure.md) |
