...
| `routers/auth_router` | `_set_auth_cookie()`, `_sync_user_from_org_tree()` | [auth_router](../api/auth_router.md) |
| `routers/api_keys_router` | `mint_api_key_for_user()` — long-lived CLI API key for desktop | [api_keys_router](../api/api_keys_router.md) |
...
| `core/graph_audit` | `record()` — audits OBO boundary crossings | [core_infrastructure](../infrastructure/core_infrastructure.md) |
| `core/logger` | Structured logging | [core_infrastructure](../infrastructure/core_infrastructure.md) |
