...
| [core_infrastructure](../core/core_infrastructure.md) | Logger, telemetry, config infrastructure |
| [sdlc_pipeline_agents](../sdlc/sdlc_pipeline_agents.md) | `ComplianceBlocked` exception consumer |
