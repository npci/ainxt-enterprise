...
For details on how these scripts are bundled and evaluated, see [skill_creator_tools](skill_creator_tools.md) and [shared_skills](shared_skills.md). For the backend services that orchestrate skill execution, see [abstudio_backend](abstudio_backend.md).
