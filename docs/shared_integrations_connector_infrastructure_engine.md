...
| Compliance engine (PCI/PII scanning) | [shared_core](shared_core.md) |
| Credential vault (Fernet encrypt/decrypt) | [shared_core](shared_core.md) |
| Connectors REST API (execute, oauth, permissions) | [shared_api_routers](shared_api_routers.md) |
