...
| [gitlab_tools](gitlab_tools.md) | Fallback remote file reader when the local workspace lacks a file. |
...
- [gitlab_tools](gitlab_tools.md) — remote file access fallback.
