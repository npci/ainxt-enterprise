...
For full backend endpoint behavior, RBAC rules, and database schema details, see [index_router.md](index_router.md) and [products_router.md](products_router.md).
...
Backend validation is duplicated in `index_router.py` for defense in depth. See [security_validation.md](security_validation.md) for the shared validation engine.
...
- **Knowledge graph**: code symbols and dependency edges are mirrored into the unified knowledge graph (see [knowledge_graph.md](knowledge_graph.md)).
...
- [index_router.md](index_router.md) — Backend API routes for index requests and repo management.
- [index_worker.md](index_worker.md) — Background worker that clones, chunks, embeds, and indexes repositories.
- [products_router.md](products_router.md) — Product catalog and department mapping APIs.
- [security_validation.md](security_validation.md) — Shared input validation utilities.
- [DialogProvider.md](DialogProvider.md) — Toast and confirmation dialog primitives.
- [knowledge_graph.md](knowledge_graph.md) — Knowledge graph ingestion and code node mirroring.
