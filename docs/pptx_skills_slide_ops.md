...
- High-level presentation generation (handled by [doc_generator](doc_generator.md) via `slides_to_pptx`).
...
For end-to-end document generation, see [doc_generator](doc_generator.md). For rendering previews, see [pptx_skills_visualization](pptx_skills_visualization.md).
...
| [doc_generator](doc_generator.md) | Higher-level tool that can generate slide content and produce `.pptx` files. |
