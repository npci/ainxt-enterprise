...
This document describes the frontend module. For the backend API implementation, see [coach_admin_router](../api/coach_admin_router.md). For the end-user coaching experience, see [Coach](coach.md).
...
|------------|--------|---------|
| `authFetch` | [config](../infrastructure/config.md) | Authenticated HTTP requests |
...
| Dependency | Module | Purpose |
|------------|--------|---------|
| `coach_admin_router.py` | [coach_admin_router](../api/coach_admin_router.md) | Admin REST API |
| `coach_router.py` | [coach_router](../api/coach_router.md) | Rule testing endpoint |
| `agents/coach_evaluator.py` | [coach_evaluator](../coach_evaluator.md) | Rule definitions, scoring, message generation |
| `db/models.py` | [db_models](../db_models.md) | `CoachEvent`, `CoachRuleHit`, `CoachScoreSnapshot`, `CoachManualNote`, `CoachAdminAudit`, `CoachRuleDisabled`, `CoachWeeklyMailOptOut` |
| `auth/rbac.py` | [rbac](../rbac.md) | `require_admin_flag` |
...
- [coach_admin_router](../api/coach_admin_router.md) — backend admin API
- [coach_router](../api/coach_router.md) — rule testing API
- [coach_evaluator](../coach_evaluator.md) — rule engine and scoring
- [config](../infrastructure/config.md) — `authFetch` configuration
- [rbac](../rbac.md) — admin authorization
