...
The dashboard calls three authenticated endpoints provided by [`evals_router.py`](../api/evals_router.md):
...
| Dependency | Module | Purpose |
|------------|--------|---------|
| `evals_router.py` | [`shared_api_routers`](../api/evals_router.md) | Serves `/evals/*` endpoints. |
...
- **[`Monitoring`](../infrastructure/monitoring.md)** — tracks queue health and circuit breakers, not LLM judgment scores.
...
- [`evals_router.md`](../api/evals_router.md) — Backend API for evaluation data.
