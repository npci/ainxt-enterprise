...
- [config.md](config.md) — `API_BASE` and `authFetch` for authenticated HTTP requests.
- [ui_dialog.md](ui_dialog.md) — `useToast` for success/error notifications.
...
- [auth.md](auth.md) — User authentication and `require_broadcast_user` authorization.
- [guardrails.md](guardrails.md) — Compliance checks on subject and body.
...
- [ai_ui_frontend.md](ai_ui_frontend.md) — Parent frontend package overview.
...
- [config.md](config.md) — API configuration and `authFetch`.
- [ui_dialog.md](ui_dialog.md) — Toast notification provider.
- [auth.md](auth.md) — Authentication and authorization.
- [guardrails.md](guardrails.md) — Runtime compliance guardrails.
