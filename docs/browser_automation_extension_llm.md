...
> **Parent module:** This module is a child of [browser_automation_extension](browser_automation_extension.md). It is consumed primarily by the [runner](browser_automation_extension_runner.md) and the [side panel](browser_automation_extension_sidepanel.md).
