...
- **Desktop and Office add-ins**: SSO flows mint long-lived API keys and store Entra OAuth tokens so the desktop app and Office add-in can call platform APIs and Microsoft 365 connectors. See the [desktop app](desktop_app.md) and [office add-in](office_addin.md) modules.
