...
|------------|----------------|---------------|
| `core_infrastructure` | Configuration, logging, telemetry, resilience, security, LLM tooling, jobs, notifications, i18n | [core_infrastructure](../infrastructure/core_infrastructure.md) |
| `database` | SQLAlchemy engines, ORM models, RLS, migrations | [database](../storage/database.md) |
| `authentication` | JWT/API-key auth, LDAP, SSO, RBAC/ABAC | [authentication](../security/authentication.md) |
...
| `model_routing` | Model selection, hybrid search, knowledge graph, KB versioning | [model_routing](../models/model_routing.md) |
...
| `store_layer` | Domain stores for budget, inbox, SDLC, threads, SSO | [store_layer](../storage/store_layer.md) |
| `services` | Budget digests, coach ingestion, Teams integration, notifications | [services](services.md) |
| `llm_spend` | LLM spend fetching and reporting | [llm_spend](../models/llm_spend.md) |
| `coach_system` | Coach rule evaluation and feedback | [coach_system](../evaluation/coach_system.md) |
| `evals_evolution` | Evaluation harness and safe self-improvement | [evals_evolution](../evaluation/evals_evolution.md) |
...
| `router_policy` | Pure model-selection policy | [router_policy](../api/router_policy.md) |
| `observability` | Turn tracing and metrics | [observability](../infrastructure/observability.md) |
| `sandbox` | Secure code and document execution | [sandbox](../storage/sandbox.md) |
...
| `kv_store` | Backend-agnostic Redis layer | [kv_store](../storage/kv_store.md) |
...
| `gunicorn_config` | Production Gunicorn configuration | [gunicorn_config](../infrastructure/gunicorn_config.md) |
