...
- [shared_core_sdlc_pipeline](../sdlc/shared_core_sdlc_pipeline.md) — the SDLC pipeline that consumes resolved dependencies.
- tools.gitlab_tools — GitLab read/write primitives.
- store.sdlc_store — persistence for run-time repo membership.
