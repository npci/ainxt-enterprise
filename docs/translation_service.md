...
- General-purpose LLM proxying: see [llm_proxy](llm_proxy.md).
- Document parsing and OCR: see [abstudio_backend](abstudio_backend.md) (`app/core/ocr_pipeline.py`).
...
- [translation_service_api](translation_service_api.md) — FastAPI endpoints, request validation, and service lifecycle.
