...
| `cowork_mcp_router` | [shared_api_routers](shared_api_routers.md) | SSE/HTTP transport, session routing |
| Anthropic doc skills | [shared_skills](shared_skills.md) | SKILL.md files for docx/pptx/xlsx/pdf |
