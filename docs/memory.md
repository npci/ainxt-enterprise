...
> See [chat.md](chat.md) for how memories are generated from conversation turns and [memory_system.md](memory_system.md) for the backend episodic-memory implementation.
...
> See [auth.md](auth.md) for authentication and [governance.md](governance.md) for compliance policies.
...
- [chat.md](chat.md) – Chat and memory generation.
...
- [auth.md](auth.md) – Authentication and user scoping.
- [governance.md](governance.md) – Compliance and sensitivity policies.
