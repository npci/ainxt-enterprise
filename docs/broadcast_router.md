...
See [shared_core](shared_core.md) for full rate limiter documentation.
...
See [shared_core](shared_core.md) for full compliance engine documentation.
...
See [shared_core](shared_core.md) for `FileValidator` documentation.
...
|------------|--------|----------------|
| `get_current_user` | `shared_core` → `authentication` | [shared_core](shared_core.md) |
| `enforce_rate_limit_with_behaviour`, `SENSITIVE_ADMIN` | `shared_core` → `core_infrastructure` | [shared_core](shared_core.md) |
| `ComplianceEngine` | `shared_core` → `agent_system` | [shared_core](shared_core.md) |
| `ModelRouter` | `shared_core` → `model_routing` | [shared_core](shared_core.md) |
| `validate_upload` | `shared_core` → `core_infrastructure` | [shared_core](shared_core.md) |
| `EmailBroadcast*` models | `shared_core` → `database` | [shared_core](shared_core.md) |
| `submit_broadcast_recipient`, `send_broadcast_recipient` | `workers` → `broadcast_coach_workers` | [workers](workers.md) |
| `send_html_email`, `SMTPSendError` | `shared_core` → `services` | [shared_core](shared_core.md) |
