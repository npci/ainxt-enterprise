...
| LLM Client | `lib/llm.js` | OpenAI-compatible completions, tool registry, planning, healing, summarization, suggestions | [browser_automation_extension_llm](../models/browser_automation_extension_llm.md) |
...
- [gateway](../models/gateway.md) — for platform-level agent/workflow orchestration.
- [abstudio_backend](../ui/abstudio_backend.md) — for no-code workflow and agent authoring.
