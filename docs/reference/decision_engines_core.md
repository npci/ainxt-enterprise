...
- [decision_engines_hardblock](../storage/decision_engines_hardblock.md) — keyword-based hard-block guardrails.
...
- `llm`: An object implementing a `complete(prompt: str) -> str` method. In practice this is often a wrapper around the [model_router](../models/model_routing.md) or a direct LLM client from [core_llm_handler](../models/core_llm_handler.md).
...
|------------|--------|---------|
| `core.logger` | [core_infrastructure](../infrastructure/core_infrastructure.md) | Structured logging for decisions and parse failures. |
| `llm` (injected) | [core_llm_handler](../models/core_llm_handler.md) / [model_routing](../models/model_routing.md) | Provides `complete(prompt)` for decision generation. |
...
| [decision_engines_hardblock](../storage/decision_engines_hardblock.md) | Sibling safety engine. Usually run before decision-making. |
...
- [decision_engines_hardblock](../storage/decision_engines_hardblock.md) — Hard-block guardrails.
- [core_llm_handler](../models/core_llm_handler.md) — LLM client abstraction.
- [model_routing](../models/model_routing.md) — Model selection and routing.
