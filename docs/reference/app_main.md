...
> See [cli_runtime](../clients/cli_runtime.md) for details on CLI workspace and session management.
...
| `mcp` | [api_mcp](../api/api_mcp.md) | MCP server testing |
...
| `cli_mcp_router` | [cli_runtime](../clients/cli_runtime.md) | MCP tool plane for spawned CLI processes |
