...
See [core_db_pool.md](../storage/core_db_pool.md) for details on the shared pool shim.
...
- [core_db_pool.md](../storage/core_db_pool.md): shares the single `_SharedPoolShim` instance; no separate pool is created.
- [core_config.md](../infrastructure/core_config.md): reads `postgres_enabled()` and other configuration flags.
- [core_governance.md](../sdlc/core_governance.md): reconciles governance status after workflow/agent mutations.

### With Models

- [app_models.md](../models/app_models.md): defines the Pydantic request/response shapes (`Workflow`, `AgentNode`, `TriggerOut`, etc.) that API routes pass into repository functions.
...
- [core_db_pool.md](../storage/core_db_pool.md) — shared PostgreSQL pool shim
- [core_config.md](../infrastructure/core_config.md) — configuration and feature flags
...
- [app_models.md](../models/app_models.md) — Pydantic data models
