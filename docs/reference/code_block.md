...
For details on how code blocks are embedded inside chat messages, see the [message](../chat/message.md) module. For the broader code-editing and diff-rendering experience, see the [code](code.md) module. For the main chat orchestration that produces the content being highlighted, see the [chat](../chat/chat.md) module.
