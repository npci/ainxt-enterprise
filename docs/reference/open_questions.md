...
| [config](../infrastructure/config.md) | `ai-ui/src/config.js` | Provides `API_BASE` and `apiFetch` for authenticated backend calls. |
...
- [config](../infrastructure/config.md) — Frontend configuration and authenticated fetch utilities.
