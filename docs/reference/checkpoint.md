...
|------------|---------|----------------|---------------|
| Workflow Checkpoint Store | `store.py`, `postgres_store.py` | Abstract interface, file-backed implementation, and PostgreSQL implementation for workflow chat / run state. | [checkpoint_workflow_store.md](../storage/checkpoint_workflow_store.md) |
