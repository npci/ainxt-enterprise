...
- **Authoring** happens in [skills_feature](../agents/skills_feature.md) and [agent_factory_pipeline](../agents/agent_factory_pipeline.md), where new tools can be generated, packaged, and registered.
...
- **Execution** is performed by [engine_native_engine](engine_native_engine.md) and [agent_factory_pipeline](../agents/agent_factory_pipeline.md) when an agent or workflow invokes a tool.
...
The Tools Catalog is typically reachable from the main navigation rendered by [app_core](app_core.md) and embedded inside [build_studio](../ui/build_studio.md).
...
- [skills_feature](../agents/skills_feature.md) for skill-centric tool packaging.
