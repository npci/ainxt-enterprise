...
- Profile schema → [profiles_schema.md](../storage/profiles_schema.md)
...
- [profiles_schema.md](../storage/profiles_schema.md) defines the data model that carries profile defaults.
...
|------------|------------|----------------|
| `profiles/schema.py` | [profiles_schema.md](../storage/profiles_schema.md) | Defines `DomainProfile`, the source of profile defaults. |
...
- [profiles_schema.md](../storage/profiles_schema.md)
