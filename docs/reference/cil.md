...
- **Downstream**: the gateway/router, [model_routing](../models/model_routing.md), [context_engine](context_engine.md), tool dispatch, and document-generation pipelines.

CIL depends on:

- [model_routing](../models/model_routing.md) — `models/model_router.py` supplies the model cascade used by `cil/intent.py`.
- [kv_store](../storage/kv_store.md) — `core/kv` provides the cache backend for intent classification results.
- [core_infrastructure](../infrastructure/core_infrastructure.md) — `core/config.py` and `core/logger.py` for configuration and logging.
...
- [model_routing.md](../models/model_routing.md) — model router and `models/doc_intent.py`.
- [kv_store.md](../storage/kv_store.md) — caching backend.
- [core_infrastructure.md](../infrastructure/core_infrastructure.md) — logging and configuration.
