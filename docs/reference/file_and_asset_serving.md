...
Caching is governed by `NoCacheMiddleware` (part of the [Security & Governance](../sdlc/security_and_governance.md) module), which wraps every response:
...
|---|---|---|
| `NoCacheMiddleware` | [Security & Governance](../sdlc/security_and_governance.md) | Sets `Cache-Control` headers on all responses |
...
- [Security & Governance](../sdlc/security_and_governance.md) — `NoCacheMiddleware`, rate limiting, and request authentication
- [Health & Monitoring](../infrastructure/health_and_monitoring.md) — Gateway health endpoints including ABStudio health check
