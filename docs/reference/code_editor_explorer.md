...
This module is part of the larger [`code_editor`](code_editor.md) feature group in [`ai_ui_frontend`](../ui/ai_ui_frontend.md), alongside [`code_editor_panel`](code_editor_panel.md) and [`code_editor_diff`](code_editor_diff.md).
...
- [`ai_ui_frontend`](../ui/ai_ui_frontend.md) — Top-level frontend documentation.
