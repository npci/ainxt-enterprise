...
This module is part of the broader [ai_ui_frontend](../ui/ai_ui_frontend.md) application and consumes the [auth_router](../api/auth_router.md) backend endpoints for user lifecycle operations.
...
| Dependency | Module | Purpose |
|------------|--------|---------|
| `GET /auth/users` | [auth_router](../api/auth_router.md) | List all users |
| `POST /auth/users` | [auth_router](../api/auth_router.md) | Create a new user |
| `PATCH /auth/users/{id}` | [auth_router](../api/auth_router.md) | Update role or active status |
...
- [Budget Manager](../models/budget_manager.md) — budget allocation and approvals
- [Model Governance](../sdlc/model_governance.md) — model access permissions
- [Level Overrides](../clients/level_overrides.md) — temporary permission elevation
