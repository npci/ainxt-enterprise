...
- Once seeded, [NativeEngine](engine_native_engine.md) wraps each row as a `_CatalogTool` and dispatches it through [ToolDispatcher](../agents/agent_factory_pipeline.md#tooldispatcher).
