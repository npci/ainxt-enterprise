...
- **Out of scope**:
  ...
  - File-level chrome such as path headers, expand/collapse buttons, or approval actions (see [code](code.md), [code_editor](code_editor.md), and [diff_approval](../sdlc/diff_approval.md)).
