...
| [`workflowStore`](../storage/store.md) | Node data | Stores the cases array as part of the condition node's data. |
...
- [`store`](../storage/store.md) — Workflow state management that persists condition node data.
