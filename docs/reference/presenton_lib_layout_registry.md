...
- **Upstream consumers**
  - [`presenton_lib_payload_builder`](../ui/presenton_lib_payload_builder.md) uses the registry to know which fields each slide type requires and to fill sensible defaults.
  - [`presenton_lib_api_client`](../api/presenton_lib_api_client.md) does not directly import the registry, but the payloads it sends must conform to the schemas defined here.
...
- **Downstream consumers**
  - [`presenton_router`](../api/presenton_router.md) on the backend receives payloads whose slide content is validated against these schemas.
...
- [`presenton_lib_payload_builder`](../ui/presenton_lib_payload_builder.md) — transforms raw slide data into schema-compliant content payloads.
- [`presenton_lib_api_client`](../api/presenton_lib_api_client.md) — network layer for Presenton endpoints.
...
- [`presenton_router`](../api/presenton_router.md) — backend API that consumes these schemas.
