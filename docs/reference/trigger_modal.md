...
`TriggerModal` uses [`apiFetch`](../infrastructure/config.md) to talk to the SDLC endpoints exposed by [`sdlc_router`](../api/sdlc_router.md). The backend then enqueues work through [`sdlc_worker`](../workers/sdlc_pipeline_workers.md).
...
| [`config`](../infrastructure/config.md) | Provides `apiFetch` for authenticated HTTP requests. |
| [`ai_ui_frontend_utils`](../ui/ai_ui_frontend_utils.md) | Provides `validateJiraKey`, `validateRepoName`, `validateBranch`, `validateSummary`. |
| [`sdlc_router`](../api/sdlc_router.md) | Backend router that receives the trigger requests. |
| [`sdlc_pipeline_workers`](../workers/sdlc_pipeline_workers.md) | Background workers that execute the triggered pipelines. |
