...
- **Connector layer**: M365 tools rely on `ConnectorEngine` and the Microsoft 365 adapter for all Graph operations. See [shared_integrations_connector_infrastructure](../connectors/shared_integrations_connector_infrastructure.md).
