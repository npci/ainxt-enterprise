...
The backend endpoint consumed by this component belongs to the SDLC subsystem (see [`sdlc_router`](../shared_api_routers_sdlc_router.md) / [`sdlc_pipeline`](../sdlc/shared_core_sdlc_pipeline.md)). The fetched dependencies are typically produced by [`agents/dep_resolver.py`](shared_core.md) or equivalent manifest parsing logic.
