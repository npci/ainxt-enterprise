...
For full backend endpoint behavior, RBAC rules, and database schema details, see [index_router.md](../api/index_router.md) and [products_router.md](../api/products_router.md).
...
- [index_router.md](../api/index_router.md) — Backend API routes for index requests and repo management.
- [index_worker.md](../index_worker.md) — Background worker that clones, chunks, embeds, and indexes repositories.
- [products_router.md](../api/products_router.md) — Product catalog and department mapping APIs.
