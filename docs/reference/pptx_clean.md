...
> **Note:** This module operates on an already-unpacked PPTX directory. For unpacking and repacking logic, see [pptx_office_unpack](../documents/pptx_office_unpack.md) and [pptx_office_pack](../documents/pptx_office_pack.md). For slide creation and duplication, see [pptx_add_slide](../clients/pptx_add_slide.md).
...
- [pptx_office_unpack](../documents/pptx_office_unpack.md) — Explodes a `.pptx` into an editable directory.
- [pptx_office_pack](../documents/pptx_office_pack.md) — Re-zips the cleaned directory back into `.pptx`.
- [pptx_office_validate](../documents/pptx_office_validate.md) — Validates OOXML schema after packing.
- [pptx_add_slide](../clients/pptx_add_slide.md) — Duplicates or creates slides in the unpacked package.
- [doc_generator](../documents/doc_generator.md) — Higher-level document generation that may orchestrate PPTX creation.
...
- Merge text runs or simplify redlines (see [pptx_office_merge_runs](../documents/pptx_office_merge_runs.md) and [pptx_office_simplify_redlines](../documents/pptx_office_simplify_redlines.md)).
