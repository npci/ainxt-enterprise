...
The resolver sits between **policy definition** ([profiles_schema](../storage/profiles_schema.md)) and **policy consumption** ([model_routing](../models/model_routing.md), [context_engine](context_engine.md), [profiles_shaping](profiles_shaping.md)). Its job is to collapse the multi-layer profile hierarchy into one immutable value object that downstream code can use without understanding merge semantics.
...
- [profiles_schema](../storage/profiles_schema.md) defines the data model.
...
|------------|--------|---------|
| `DomainProfile` | [profiles_schema](../storage/profiles_schema.md) | The layered policy bundle to resolve. |
| `ContextPolicy` | [profiles_schema](../storage/profiles_schema.md) | Source of scalar context knobs. |
| `RoutingPolicy` | [profiles_schema](../storage/profiles_schema.md) | Source of routing weights and constraints. |
| `GroundingPolicy` | [profiles_schema](../storage/profiles_schema.md) | Source of grounding posture. |
...
| Model router | [model_routing](../models/model_routing.md) | Routing constraints and privacy floor |
