...
| [connectors_router.md](../api/connectors_router.md) | API endpoints `dpi_consent_start` and `dpi_consent_store`, plus request models `DpiConsentStartRequest` and `DpiConsentStoreRequest`. |
