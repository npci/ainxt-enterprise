...
| [compliance_scan_router](compliance_scan_router.md) | Provides `/compliance/scan-image` for screenshot PAN/PII redaction. |
...
- [compliance_scan_router](compliance_scan_router.md) — Gateway image/text redaction service.
