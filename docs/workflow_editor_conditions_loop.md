...
| Dependency | Module | Role |
|------------|--------|------|
| `buildCombinedExpressionPreview` | [constants/operators.js](constants.md) | Builds the live plain-English expression preview. |
| `FIELDS`, `getFieldType`, `getOperatorsForType`, `getDefaultValue`, `DEFAULT_OPERATOR` | [constants/operators.js](constants.md) | Canonical field registry, type inference, and operator lists. |
...
- [constants](constants.md) — operator definitions, field registry, and expression helpers.
