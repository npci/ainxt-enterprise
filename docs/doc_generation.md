...
- [services.md](services.md) — HITL mode parsing, condition DSL, and helper functions.
- [checkpoint.md](checkpoint.md) — pause snapshots and per-node output persistence.
- [chat.md](chat.md) — SSE chat endpoint that delivers `hitl_interrupt` events.
- [workflowStore.md](workflowStore.md) — frontend execution payload and node defaults.
- [ConfigPanel.md](ConfigPanel.md) — UI editor for HITL mode, loop config, and asset references.
...
- **See**: [native_engine.md](native_engine.md), [services.md](services.md), [checkpoint.md](checkpoint.md), [chat.md](chat.md), [ConfigPanel.md](ConfigPanel.md).
...
- **See**: [native_engine.md](native_engine.md), [services.md](services.md), [workflowStore.md](workflowStore.md), [ConfigPanel.md](ConfigPanel.md).
...
- [ConfigPanel.md](ConfigPanel.md)
- [LoopItemsPicker.md](LoopItemsPicker.md)
