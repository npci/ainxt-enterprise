...
This module lives inside `gateway.py` and delegates all persistence to dedicated subsystems. See [gateway.md](gateway.md) for the broader gateway architecture and [core_telemetry.md](core_telemetry.md) for the underlying tracing implementation.
...
- [gateway.md](gateway.md) — overall gateway routing, middleware registration, and handler organization.
