...
| [core_logger](../core/shared_core.md#logging) | Uses | Logs server lifecycle and errors via `core.logger`. |
...
It can also be registered with the platform's MCP registry and exposed through the [mcp_server_router](../core/shared_api_routers.md#mcp_server_router) over SSE or streamable HTTP.
...
- [shared_api_routers.md#mcp_server_router](../core/shared_api_routers.md#mcp_server_router) — HTTP/SSE registration and routing for MCP servers.
