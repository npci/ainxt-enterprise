...
| Dependency | Module | Role |
|------------|--------|------|
| `buildCombinedExpressionPreview` | [constants/operators.js](../core/constants.md) | Builds the live plain-English expression preview. |
| `FIELDS`, `getFieldType`, `getOperatorsForType`, `getDefaultValue`, `DEFAULT_OPERATOR` | [constants/operators.js](../core/constants.md) | Canonical field registry, type inference, and operator lists. |
...
- [constants](../core/constants.md) — operator definitions, field registry, and expression helpers.
