...
| **ConfigPanel** | Right-hand configuration sidebar for the selected node. Handles agent settings, condition cases, loop modes, subflow linking, knowledge, triggers, and model selection. | [ConfigPanel.md](../ui/ConfigPanel.md) |
| **ChatPanel** | Workflow execution chat surface. Sends/runs workflows, consumes SSE events, renders streaming messages, tool calls, HITL interrupts, and generated-file downloads. | [ChatPanel.md](../ui/ChatPanel.md) |
