...
| [`BrandMark`](../ui/brand_mark.md) | AiNxt logo rendering |
| [`AiNxtSpinner`](../ui/spinner.md) | Loading spinner with status label |
| [`DiffLines`](../ui/code_editor.md) | Lightweight diff line renderer |
| [`FileExplorer`](../ui/code_editor.md) | File tree browser |
| [`FileEditorPanel`](../ui/code_editor.md) | CodeMirror editor with edit/diff/preview modes |
| [`config`](../core/config.md) | `authFetch` and `API_BASE` for server API calls |
...
> **Desktop implementation:** See [cowork_desktop](../cowork/cowork_desktop.md) for the main-process side of this IPC bridge, including the CLI session manager and NDJSON stream parsing.
