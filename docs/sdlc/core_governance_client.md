...
- [`core/workflow_repo.py`](../reference/core_workflow_repo.md) — invokes the client during template use and artifact updates.
...
- [`routers/governance_router`](../api/governance_router.md) — platform authority for governance status, transitions, notifications, and audit events.
- [`db.models`](../db_models.md) — defines the mirror record schemas.
