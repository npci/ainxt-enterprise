...
For full router details, see [shared_api_routers](../api/shared_api_routers.md).
...
|----------------|--------------|
| [shared_api_routers](../api/shared_api_routers.md) | Hosts the `model_governance_router.py` REST API. |
...
| [auth](../security/auth.md) | All governance mutations require admin privileges (`_require_admin`). |
| [dept_metrics](../infrastructure/dept_metrics.md) | The UI fetches the department list from `/dept-metrics/departments`. |
| [chat](../chat/chat.md) / [kb_chat](../knowledge/kb_chat.md) / [ide_router](../api/ide_router.md) | Consumers of `get_my_models` that hide disallowed models from model pickers. |
...
- Related docs: [shared_api_routers](../api/shared_api_routers.md), [model_router](../model_router.md), [auth](../security/auth.md), [dept_metrics](../infrastructure/dept_metrics.md)
