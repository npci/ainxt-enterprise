...
> For the orchestration layer that wires these primitives into full pipeline runs, see [shared_core_sdlc_pipeline.md](shared_core_sdlc_pipeline.md). For the worker layer that schedules SDLC jobs, see [sdlc_pipeline_workers.md](../workers/sdlc_pipeline_workers.md).
...
- [sdlc_agent_loop.md](../agents/sdlc_agent_loop.md) – autonomous agent loop runtime.
- [sdlc_governance.md](sdlc_governance.md) – governance review engine.
- [sdlc_pipeline_workers.md](../workers/sdlc_pipeline_workers.md) – `rq` worker wrappers that schedule and resume pipelines.
