...
- core_logger.md – logging utilities used for warnings and run attribution.
- models_model_router.md – model routing and fallback decisions surfaced by `_emit_fallback_event_if_any`.
