...
| Backend pipeline execution | [`sdlc_pipeline_workers.md`](sdlc_pipeline_workers.md), [`shared_core_sdlc_pipeline.md`](shared_core_sdlc_pipeline.md) |
| API routing | [`sdlc_router.md`](sdlc_router.md) |
...
- [`sdlc_pipeline_workers.md`](sdlc_pipeline_workers.md) — Background workers that execute SDLC runs.
- [`sdlc_router.md`](sdlc_router.md) — API router exposing the manifest endpoint.
