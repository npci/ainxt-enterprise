...
| [skills_feature](../skills/skills_feature.md) | One of the governed artifact types; skill content is resolved and hashed before submission. |
| ai_ui_frontend | Approvers review and act on `governance_approval` items in the `ai-ui` sidebar Inbox. |
