...
- [open_questions](../core/open_questions.md) — Open questions form for classify-raised gates
- [work_item_panel](../ui/work_item_panel.md) — Work item panel for normalization gates
- [sdlc_router](sdlc_router.md) — Backend SDLC API router (all endpoints called by this module)
- [sdlc_pipeline_workers](sdlc_pipeline_workers.md) — Background workers that process enqueued resume/retry jobs
