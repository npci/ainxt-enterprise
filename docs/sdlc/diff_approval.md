...
| Module | Relationship |
| ------ | ------------ |
| [ai_ui_frontend_app_core](../ui/ai_ui_frontend_app_core.md) | Top-level app shell that routes to the SDLC pipeline. |
| [sdlc_pipeline](sdlc_pipeline.md) | Parent component that hosts `DiffApprovalPanel` at approval gates. |
| [code_editor](../reference/code_editor.md) | Related code-editing UI; `DiffApprovalPanel` provides read-only diff visualization. |
