...
For the backend governance engine, skill execution, and API contract, see [shared_core_sdlc_pipeline](shared_core_sdlc_pipeline.md) and [shared_api_routers/sdlc_router](../api/shared_api_routers.md). For the parent UI that hosts this panel, see [sdlc_pipeline](sdlc_pipeline.md).
...
- [shared_api_routers](../api/shared_api_routers.md) — FastAPI routers, including `sdlc_router.py`.
