...
- Runs the code-profile agentic loop (see [sdlc_agent_loop](sdlc_agent_loop.md)) against the build errors
...
- **[sdlc_agent_loop](sdlc_agent_loop.md)** — `AgentLoop` used by the agent-fix branch
- **[sdlc_pipeline_workers](sdlc_pipeline_workers.md)** — Worker jobs that trigger the pipeline
