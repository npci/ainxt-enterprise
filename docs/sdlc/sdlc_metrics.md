...
For the active execution path of the SDLC pipeline, see [sdlc_pipeline](sdlc_pipeline.md), [sdlc_state_machine](sdlc_state_machine.md), and [sdlc_agent_loop](../agents/sdlc_agent_loop.md). For the store layer that supplies events and artifacts, see [sdlc_store](../sdlc_store.md) and [sdlc_artifacts](../sdlc_artifacts.md).
