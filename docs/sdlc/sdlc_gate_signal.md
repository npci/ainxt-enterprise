...
|----------|--------|--------|
| `GET /sdlc/runs/{runId}/stages/PLAN/artifact` | [sdlc_router](../api/sdlc_router.md) | Coverage |
| `GET /sdlc/runs/{runId}/stages/MANIFEST_VALIDATION/artifact` | [sdlc_router](../api/sdlc_router.md) | Manifest Validation |
| `GET /sdlc/runs/{runId}/events` | [sdlc_router](../api/sdlc_router.md) | Review |
| `GET /sdlc/runs/{runId}/verified-diff` | [sdlc_router](../api/sdlc_router.md) | Compile, Tests, Waivers, Secondary signals |
...
- The [sdlc_pipeline_workers](../workers/sdlc_pipeline_workers.md) that execute the pipeline stages asynchronously.
- The [sdlc_router](../api/sdlc_router.md) that exposes the artifact and event endpoints.
...
- [sdlc_router](../api/sdlc_router.md) — backend router exposing the consumed endpoints.
- [shared_core_sdlc_pipeline](shared_core_sdlc_pipeline.md) — core SDLC pipeline agents.
- [sdlc_pipeline_workers](../workers/sdlc_pipeline_workers.md) — asynchronous SDLC pipeline workers.
