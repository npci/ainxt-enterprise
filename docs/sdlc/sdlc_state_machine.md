...
| [sdlc_agent_loop](../agents/sdlc_agent_loop.md) | Bounded Anthropic tool-use loop for post-gate recovery (build/test). |
...
| [sdlc_implement_prompt](../sdlc_implement_prompt.md) | Pure prompt assembly functions shared with offline probes. |
| [sdlc_cli_budget](../sdlc_cli_budget.md) | Per-run CLI turn budget resolution and usage tracking. |
| [workspace_sync_worker](../workspace_sync_worker.md) | Per-run workspace materialization, cleanup, and multi-repo dep staging. |
| [store/sdlc_store](../sdlc_store.md) | Run state persistence, event logging, and context patching. |
