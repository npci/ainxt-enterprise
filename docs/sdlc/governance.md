...
| `PENDING_APPROVAL` | Submitted for manager/HOD approval (or admin-only in flat mode — see [`governance_router`](../api/governance_router.md)'s `HOD_APPROVAL_ENABLED` note) | No |
