...
- **[core_llm_handler](../models/core_llm_handler.md)** — model names observed in usage payloads flow into `estimate_model_cost`.
- **[core_workflow_repo](../reference/core_workflow_repo.md)** — workflow definitions supply `node_data` such as `allowed_tools` and `blocked_tools`.

The module itself delegates to platform services rather than reimplementing them:

- **[core.request_audit](../infrastructure/core_infrastructure.md)** for audit persistence.
- **[store.budget_store](../storage/store_layer.md)** for budget checks and usage increments.
- **[core.model_registry](../infrastructure/core_infrastructure.md)** for per-model pricing.
- **[gateway_local_llm](../models/local_llm_gateway.md)** for local model discovery.
...
- [core_config.md](../infrastructure/core_config.md) — environment configuration patterns.
- [core_llm_handler.md](../models/core_llm_handler.md) — model usage and fallback handling.
- [core_workflow_repo.md](../reference/core_workflow_repo.md) — workflow and node persistence.
