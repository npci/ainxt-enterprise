...
|---|---|---|
| `auth.dependencies.get_current_user` | [authentication](../security/authentication.md) | JWT extraction for user endpoints |
| `auth.rbac.require_admin_flag` | [authentication](../security/authentication.md) | Admin-gate for admin endpoints |
| `core.rate_limiter` | [core_infrastructure](../infrastructure/core_infrastructure.md) | `SENSITIVE_ADMIN` rate-limit tier |
