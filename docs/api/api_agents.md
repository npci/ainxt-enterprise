...
The repository persists agents in a PostgreSQL table with the following conceptual schema (see [`core_workflow_repo.md`](../workflows/core_workflow_repo.md) for the exact SQL and serialization logic):
...
- [`core_workflow_repo.md`](../workflows/core_workflow_repo.md) — Agent persistence, name validation, and governance reconciliation.
...
- [`app_models.md`](../core/app_models.md) — `AuthenticatedUser` and request/response models.
