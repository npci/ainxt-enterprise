...
| `workers/sdlc_worker.py` | SDLC pipeline worker jobs (bug, feature, PR review, merge, comments) | [sdlc_pipeline_workers](../workers/sdlc_pipeline_workers.md) |
...
| `agents/brd_fsd_pipeline.py` | BRD→FSD document generation pipeline | [sdlc_pipeline_agents](../agents/sdlc_pipeline_agents.md) |
...
- **[sdlc_pipeline_workers](../workers/sdlc_pipeline_workers.md)**: The primary consumer of jobs enqueued by this router. All SDLC pipeline jobs (bug, feature, PR review, merge, address comments) are executed by `workers/sdlc_worker.py`.
...
- **[sdlc_pipeline_agents](../agents/sdlc_pipeline_agents.md)**: The BRD→FSD pipeline agent invoked when Jira issues carry the `BRD` label.
