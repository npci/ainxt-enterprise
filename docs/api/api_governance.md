...
|--------|---------------|---------|
| `AuthenticatedUser` | [`app_models`](../models/app_models.md) | Typed user context from the JWT. |
| `require_access` | [`api_deps`](api_deps.md) | Authentication/authorization dependency. |
| `workflow_repo` | [`core_workflow_repo`](../reference/core_workflow_repo.md) | Reads workflows, agents, and skills from Build Studio tables. |
...
- [`app_models`](../models/app_models.md) — shared Pydantic models including `AuthenticatedUser`.
- [`core_workflow_repo`](../reference/core_workflow_repo.md) — Build Studio artifact repository.
