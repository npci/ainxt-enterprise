...
The router is mounted under the `/auth` prefix (see [gateway.md](../models/gateway.md) for the application route table) and provides three operations:
...
- [gateway.md](../models/gateway.md) — top-level FastAPI application and router mounting.
