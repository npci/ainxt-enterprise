...
[shared_core.md](../reference/shared_core.md) for details on auth, core utilities, store
...
> [shared_core.md](../reference/shared_core.md) for the full authentication and
> authorization model.
...
- **`store.docs_store`** — the canonical store layer for all KB document CRUD,
  chunking, deduplication, and file management. See [shared_core.md](../reference/shared_core.md).
...
- **`store.inbox_store`** — delivers approval/rejection notifications to user
  inboxes. See [shared_core.md](../reference/shared_core.md).
- **`core.job_queue` / `Q_KB`** — RQ-backed job queue with back-pressure and
  retry. See [shared_core.md](../reference/shared_core.md).
- **`agents.compliance_engine`** — PII/PCI detection and redaction. See
  [shared_core.md](../reference/shared_core.md).
- **`core.document_parser` / `core.docling_parser`** — legacy and advanced
  document parsing, scanned-PDF detection. See [shared_core.md](../reference/shared_core.md).

---

## 11. Related Documentation

- [shared_core.md](../reference/shared_core.md) — Auth/RBAC, core utilities, store layer,
...
- [gateway.md](../models/gateway.md) — Main API gateway that mounts shared API routers
