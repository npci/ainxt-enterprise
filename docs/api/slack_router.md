...
- **`core.slack_bot`** — HMAC-SHA256 signature verification and outbound Slack
  messaging (see [core_infrastructure.md](../infrastructure/core_infrastructure.md)).
- **`core.job_queue`** — asynchronous agent job dispatch (see
  [core_infrastructure.md](../infrastructure/core_infrastructure.md)).
...
| [core_infrastructure.md](../infrastructure/core_infrastructure.md) | `core.slack_bot`, `core.job_queue`, and `core.logger` utilities. |
