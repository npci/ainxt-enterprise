...
- **[shared_integrations](../skills/shared_integrations.md)** — Sibling tool modules (e.g., [jira_tools](../skills/shared_integrations.md#jira_tools), [calendar_tools](../skills/shared_integrations.md#calendar_tools)) follow the same pattern and may be composed with task tracker tools in workflows.
...
- **Composable**: Agents can chain `create_task` with [email_tools](../skills/shared_integrations.md#email_tools) to send notifications, or with [calendar_tools](../skills/shared_integrations.md#calendar_tools) to schedule follow-ups.
...
- **Governable**: `create_task` and `update_task` are flagged for PCI audit in the MCP server, aligning with platform governance requirements. See [mcp_servers](../mcp/mcp_servers.md) and [core_governance](../core/shared_core.md#core_governance) for audit handling.
