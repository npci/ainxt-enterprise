...
- **Execution** — [`cowork_scheduler`](../workers/cowork_scheduler.md) and [`cowork_task_worker`](../cowork_task_worker.md) read task rows (including `project_id`) and run them headlessly.
