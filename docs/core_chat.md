...
the backend via `authFetch` (see [config](config.md)), and delegates rendering
...
|---|---|---|
| `config.js` (`authFetch`, `API`) | Authenticated API calls and base URL | [config](config.md) |
| `useFileDrop` | Drag-and-drop file handling | [ai_ui_frontend_hooks](ai_ui_frontend_hooks.md) |
| `Message` / `MessageMeta` | Message bubble and metadata rendering | [message](message.md), [message_meta](message_meta.md) |
| `AiNxtSpinner` / `Skeleton` | Loading and skeleton states | [spinner](spinner.md), [skeleton](skeleton.md) |
| `VoiceMode` | Full-screen voice conversation overlay | [voice_mode](voice_mode.md) |
| `MemoryPanel` | User memory viewer | [memory_panel](memory_panel.md) |
| `ArtifactsPanel` | Canvas for HTML/SVG/Mermaid artifacts | [artifacts_panel](artifacts_panel.md) |
| `DocumentPreviewModal` | File attachment preview | [document_preview](document_preview.md) |
| `PPTWizard` / `PPTChatMessageRenderer` | Presentation generation | [ppt_wizard](ppt_wizard.md), [ppt_chat](ppt_chat.md) |
| `useToast` / `useConfirm` | Toast notifications and confirmation dialogs | [ui_dialog](ui_dialog.md) |
| `generateImage` | Image generation API helper | [chat](chat.md) |
| `stripMemoryTag`, `parseMemoryTag`, `stripSystemPrefix`, etc. | Content sanitisation utilities | [ai_ui_frontend_utils](ai_ui_frontend_utils.md) |
...
[model_governance](model_governance.md) and
[endpoint_manager](endpoint_manager.md) for backend details.
...
[kb_chat](kb_chat.md) for the KB-embedded chat variant.
...
[kb_chat](kb_chat.md) until the duplication is extracted into a shared hook.
...
- [kb_chat](kb_chat.md) — Knowledge Base embedded chat variant
...
- [ai_ui_frontend_hooks](ai_ui_frontend_hooks.md) — `useFileDrop`, `useDesktop`
- [ai_ui_frontend_utils](ai_ui_frontend_utils.md) — Content utilities and cache
- [gateway](gateway.md) — Backend gateway service
- [chat_router](chat_router.md) — Backend chat API routes
- [agents_catalog](agents_catalog.md) — Agent catalog and execution
- [budget](budget.md) — User budget management
- [model_governance](model_governance.md) — Model permission governance
- [coach](coach.md) — Coach rule evaluation and inline hits
- [ppt_wizard](ppt_wizard.md) — Presentation generation wizard
- [voice_mode](voice_mode.md) — Voice conversation mode
- [spinner](spinner.md) — Loading spinner component
- [skeleton](skeleton.md) — Skeleton loading states
- [ui_dialog](ui_dialog.md) — Toast and confirmation providers
