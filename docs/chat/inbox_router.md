...
This module is part of the shared API router layer. It depends on the [store layer](../storage/store_layer.md) for persistence and pub/sub, the [authentication module](../auth/authentication.md) for identity and authorization, and the [database models](../storage/database.md) for the entity records it aggregates.
