...
The chat module integrates with three layers of memory, documented in detail in [memory_system](../reference/memory_system.md).
...
- **[model_and_tool_listing](../models/model_and_tool_listing.md)** — Model listing, tool catalog
- **[openai_compatible_endpoints](../reference/openai_compatible_endpoints.md)** — Anthropic Messages API compatibility
- **[audit_and_tracing](../reference/audit_and_tracing.md)** — Request tracing, audit logging
- **[security_and_governance](../sdlc/security_and_governance.md)** — Compliance engine, rate limiting, guardrails
- **[memory_system](../reference/memory_system.md)** — RedisMemory, PostgresMemory, chat_summarizer, structured_facts
- **[database](../storage/database.md)** — Chat, ChatMessage, ChatAttachment models
- **[core_infrastructure](../infrastructure/core_infrastructure.md)** — KV store, telemetry, circuit breaker, distributed semaphore
- **[llm_proxy_main](../models/llm_proxy_main.md)** — LLM proxy service for vision and text generation
- **[chat_agent_execution_workers](../workers/chat_agent_execution_workers.md)** — `chat_worker.py`, `kafka_consumer.py`
- **[kafka_event_consumer](../reference/kafka_event_consumer.md)** — `_handle_chat_history` consumer
