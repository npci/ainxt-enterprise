...
The chat module integrates with three layers of memory, documented in detail in [memory_system](../storage/memory_system.md).
...
- **[memory_system](../storage/memory_system.md)** — RedisMemory, PostgresMemory, chat_summarizer, structured_facts
