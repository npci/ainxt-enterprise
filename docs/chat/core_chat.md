...
the backend via `authFetch` (see [config](../infrastructure/config.md)), and delegates rendering
...
|---|---|---|
| `config.js` (`authFetch`, `API`) | Authenticated API calls and base URL | [config](../infrastructure/config.md) |
...
| `AiNxtSpinner` / `Skeleton` | Loading and skeleton states | [spinner](../reference/spinner.md), [skeleton](../reference/skeleton.md) |
| `VoiceMode` | Full-screen voice conversation overlay | [voice_mode](../reference/voice_mode.md) |
| `MemoryPanel` | User memory viewer | [memory_panel](../reference/memory_panel.md) |
| `ArtifactsPanel` | Canvas for HTML/SVG/Mermaid artifacts | [artifacts_panel](../reference/artifacts_panel.md) |
| `DocumentPreviewModal` | File attachment preview | [document_preview](../documents/document_preview.md) |
| `PPTWizard` / `PPTChatMessageRenderer` | Presentation generation | [ppt_wizard](../reference/ppt_wizard.md), [ppt_chat](ppt_chat.md) |
...
[model_governance](../sdlc/model_governance.md) and
[endpoint_manager](../reference/endpoint_manager.md) for backend details.
...
- [config](../infrastructure/config.md) — `authFetch` and `API` configuration
...
- [gateway](../models/gateway.md) — Backend gateway service
- [chat_router](../api/chat_router.md) — Backend chat API routes
- [agents_catalog](../agents/agents_catalog.md) — Agent catalog and execution
- [budget](../models/budget.md) — User budget management
- [model_governance](../sdlc/model_governance.md) — Model permission governance
- [coach](../evaluation/coach.md) — Coach rule evaluation and inline hits
- [ppt_wizard](../reference/ppt_wizard.md) — Presentation generation wizard
- [voice_mode](../reference/voice_mode.md) — Voice conversation mode
- [spinner](../reference/spinner.md) — Loading spinner component
- [skeleton](../reference/skeleton.md) — Skeleton loading states
