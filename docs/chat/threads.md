...
- [threads_router.md](../api/threads_router.md)
- [chat_router.md](../api/chat_router.md)
- [budget_router.md](../api/budget_router.md)
- [index_router.md](../api/index_router.md)
- [products_router.md](../api/products_router.md)
...
It complements other `ai-ui` modules such as [chat.md](chat.md), [kb_chat.md](../knowledge/kb_chat.md), [discussions.md](discussions.md), and [sdlc_pipeline.md](../sdlc/sdlc_pipeline.md) by providing a project-threaded context for both human collaboration and AI-assisted engineering workflows.
