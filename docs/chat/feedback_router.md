...
| [memory_router.md](../storage/memory_router.md) | Consumes preference memory entries written from feedback. |
...
> For the full chat lifecycle, see [chat_router.md](chat_router.md). For how feedback drives memory and personalization, see [memory_router.md](../storage/memory_router.md).
