...
| `/health` | GET | [`app_main`](../reference/app_main.md) | Backend + DB health polling |
...
reload.  See [`threadHelpers`](../reference/utils.md) for the shared sanitisation logic.
...
- **Active thread per workflow** is persisted via `saveActiveThread()` / `loadActiveThread()`
  in [`editorPersistence`](../reference/utils.md), so a browser reload reopens the same conversation.
...
[`TriggerNotifications`](../reference/triggers_feature.md) to skip the toast pop-up for executions
...
All downloads route through [`useGeneratedDownload`](../reference/shared_features.md), which:
...
| `ExtractedTextPreview` | [`shared_features`](../reference/shared_features.md) | Attachment text preview modal |
| `DownloadNotice` | [`shared_features`](../reference/shared_features.md) | Download expiry / error notice |
| `useGeneratedDownload` | [`shared_features`](../reference/shared_features.md) | Auth'd download orchestration |
| `sniffGeneratedFiles` | [`shared_features`](../reference/shared_features.md) | Detect generated filenames in prose |
| `threadHelpers` | [`utils`](../reference/utils.md) | Thread grouping, title, preview, history mapping |
| `editorPersistence` | [`utils`](../reference/utils.md) | Active thread + composer draft persistence |
...
| `/health` | [`app_main`](../reference/app_main.md) | Backend health polling |
| `NativeEngine` | [`engine_native_engine`](../reference/engine_native_engine.md) | SSE event source (consumed indirectly) |
| `LoopRunner` | [`loop_runner`](../reference/loop_runner.md) | Loop evaluation events (consumed indirectly) |
...
- [Canvas (`workflows_feature_editor_canvas`)](../ui/workflows_feature_editor_canvas.md) — React Flow canvas with node activation
...
- [Native Engine (`engine_native_engine`)](../reference/engine_native_engine.md) — SSE event source
- [Loop Runner (`loop_runner`)](../reference/loop_runner.md) — Loop evaluation events
- [Swarm (`swarm`)](../agents/swarm.md) — Sub-agent orchestration
- [Shared Features (`shared_features`)](../reference/shared_features.md) — `ExtractedTextPreview`, `DownloadNotice`, `useGeneratedDownload`
- [Utils (`utils`)](../reference/utils.md) — `threadHelpers`, `editorPersistence`
- [Triggers Feature (`triggers_feature`)](../reference/triggers_feature.md) — `TriggerNotifications` bell integration
