...
- **[FileHandling](../reference/FileHandling.md)** — `FileDownloadCard`, `fallbackDownload`, and authenticated generated-file downloads.

## Key Dependencies

- **[workflowStore](../workflowStore.md)** — Provides `chatMessages`, `executionLogs`, `isExecuting`, and run context.
- **[api_execution](../api/api_execution.md)** — Backend endpoints that stream workflow execution events.
- **[api_documents](../api/api_documents.md)** — Serves generated files consumed by `FileHandling`.
- **[utils/threadHelpers.js](../reference/utils.md)** — Maps backend history to UI messages.
- **[utils/editorPersistence.js](../reference/utils.md)** — Persists composer drafts per workflow/thread.