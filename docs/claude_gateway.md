...
| Concern | Module | Link |
|---------|--------|------|
| Model registry & pricing | `core.model_registry` | [core_model_registry](core_model_registry.md) |
| Prompt-cache egress transport | `core.claude_cache_egress` | [core_claude_cache_egress](core_claude_cache_egress.md) |
| Retry policy | `core.retry` | [core_retry](core_retry.md) |
| Circuit breaker | `core.circuit_breaker` | [core_circuit_breaker](core_circuit_breaker.md) |
| Prompt sanitization | `core.prompt_sanitizer` | [core_prompt_sanitizer](core_prompt_sanitizer.md) |
| Tool-use proxy / web-search governance | `core.proxy_tool_use` | [core_proxy_tool_use](core_proxy_tool_use.md) |
| Compliance scanning | `agents.compliance_engine` | [agents_compliance_engine](agents_compliance_engine.md) |
| Structured logging / request IDs | `core.logger` | [core_logger](core_logger.md) |
| Streaming event markers | `pipeline.stream_events` | [pipeline_stream_events](pipeline_stream_events.md) |
...
- [core_model_registry](core_model_registry.md) — model IDs, blocked models, and per-1M token pricing.
- [core_claude_cache_egress](core_claude_cache_egress.md) — Anthropic cache-control transport implementation.
- [core_retry](core_retry.md) and [core_circuit_breaker](core_circuit_breaker.md) — resilience policies.
- [core_prompt_sanitizer](core_prompt_sanitizer.md) — input sanitization.
- [core_proxy_tool_use](core_proxy_tool_use.md) — tool execution governance and proxy path.
- [agents_compliance_engine](agents_compliance_engine.md) — compliance scanning.
- [pipeline_stream_events](pipeline_stream_events.md) — `ReasoningMarker` and streaming event types.
