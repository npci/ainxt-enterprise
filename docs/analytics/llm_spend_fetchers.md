...
- **Depends on**: [`llm_proxy`](../llm/llm_proxy_main.md) for egress, `core.model_registry` for registry defaults, [`db.database`](../storage/database.md) for persistence, and [`ainxt.model_usages`](../storage/database.md) for recently observed models.
