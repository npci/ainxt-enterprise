...
| `core.rate_limiter` | [core_infrastructure](core_infrastructure.md) | `enforce_rate_limit`, rate-limit configs |
| `core.logger` | [core_infrastructure](core_infrastructure.md) | Structured logging |
| `core.security_validation` | [core_infrastructure](core_infrastructure.md) | `validate_level_override_request` |
| `core.config` | [core_infrastructure](core_infrastructure.md) | `LDAP_ENABLED`, `redis_client`, `RDB_QUEUE` |
| `core.kv` | [kv_store](kv_store.md) | `get_kv` (Redis abstraction for JWT blacklist) |
| `db.database` | [database](database.md) | `SessionLocal` |
| `db.models` | [database](database.md) | `User`, `OrgTree`, `UserLevelOverride` |
| `store.inbox_store` | [store_layer](store_layer.md) | `publish_inbox_item` |
| `services.hierarchy_service` | [services](services.md) | `has_direct_reports` |
