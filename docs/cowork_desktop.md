...
|---|---|---|
| Desktop IPC | `useDesktop.js` hook | [ai_ui_frontend_hooks](ai_ui_frontend_hooks.md) |
| Scheduled tasks | `CoworkScheduler.jsx` | [cowork_scheduler](cowork_scheduler.md) |
| Document generation cards | `DocDownloadButton` in `Message.jsx` | [message](message.md) |
| Cost/token meta | `MessageMeta.jsx` | [message_meta](message_meta.md) |
| Dialogs/toasts | `DialogProvider.jsx` | [ui_dialog](ui_dialog.md) |
| Conversation API | `/cowork/conversations` | [cowork_conversations_router](cowork_conversations_router.md) |
| Project API | `/cowork/projects` | [cowork_projects_router](cowork_projects_router.md) |
| Memory API | `/cowork/prefs`, `/cowork/memory/note` | [cowork_admin_router](cowork_admin_router.md) |
| Task API | `/cowork/tasks` | [cowork_tasks_router](cowork_tasks_router.md) |
| File upload | `/chat/upload` | [chat_router](chat_router.md) |
| Document fallback | `/docs/generate` | [doc_download_router](doc_download_router.md) |
| Model governance | `/model-governance/my-models`, `/cowork/model-config` | [model_governance_router](model_governance_router.md) |
| Desktop main process | `CoworkSessionManager`, `CliSession` | [desktop_app](desktop_app.md) |
...
- [ai_ui_frontend_app_core](ai_ui_frontend_app_core.md) — top-level app shell and navigation.
- [cowork_scheduler](cowork_scheduler.md) — recurring task scheduling UI.
- [cowork_canvas](cowork_canvas.md) — document preview and AI editing canvas.
- [cowork_settings](cowork_settings.md) — role and permission configuration.
- [desktop_app](desktop_app.md) — Electron main process and CLI session management.
- [chat_router](chat_router.md) — chat/file upload backend endpoints.
- [doc_download_router](doc_download_router.md) — document generation fallback endpoints.
- [model_governance_router](model_governance_router.md) — model allow-list and lock configuration.
