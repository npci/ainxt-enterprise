...
The Skeleton module is a pure presentational layer. It depends only on React and Tailwind CSS utility classes, and has no runtime dependencies on other application modules. Other modules (such as [chat](chat.md), [kb_chat](kb_chat.md), and [message](message.md)) import these components to show loading states while waiting for backend responses.
...
> See [chat](chat.md), [kb_chat](kb_chat.md), and [message](message.md) for how these loading states are integrated into the chat experience.
...
- [chat](chat.md) — loading states for the main chat interface.
- [kb_chat](kb_chat.md) — loading states for knowledge-base chat.
- [message](message.md) — placeholder rendering while message content is prepared.
...
> See [message](message.md) for the real message rendering logic.
...
- [kb_chat](kb_chat.md)
- [message](message.md)
- [ai_ui_frontend_app_core](ai_ui_frontend_app_core.md)
