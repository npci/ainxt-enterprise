...
- **[`core.config.redis_client`](core_config.md)** — Returns a configured Redis client for the requested database number. The router uses database `2` for transient agent coordination.
