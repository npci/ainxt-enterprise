...
- **Upstream consumers**
  ...
  - [`ppt_wizard`](ppt_wizard.md) and [`chat`](chat.md) components initiate presentation generation and may preview available layouts.
...
- **Downstream consumers**
  ...
  - [`workers/presenton_worker`](workers.md) renders the final `.pptx` using the layout ids and content sent from the frontend.
