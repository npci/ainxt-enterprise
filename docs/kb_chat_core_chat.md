...
- [core_chat_logic](core_chat_logic.md) — message lifecycle handlers (continue, regenerate, stop, voice send).
- [feedback_and_sharing](feedback_and_sharing.md) — message feedback submission and public chat sharing.
- [config](config.md) — `authFetch` and API base configuration.
- [chat_router](chat_router.md) — backend chat and share endpoints.
