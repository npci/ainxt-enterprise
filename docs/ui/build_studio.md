...
For the actual application logic, routing, dashboards, and editors, see the [app_core](../reference/app_core.md) module and its feature-area children.
...
The only exported component in this module. It is intentionally thin: all business logic, state management, and feature UI live in [app_core](../reference/app_core.md) and the feature modules.
...
|------------|------------|---------|
| `App.jsx` | [app_core](../reference/app_core.md) | The actual Build Studio application shell, routing, and section state. |
| `AppErrorBoundary` | [app_core](../reference/app_core.md) | Catches errors inside the builder tree. |
| Feature components | [agents_feature](../agents/agents_feature.md), [workflows_feature](../workflows/workflows_feature.md), [skills_feature](../agents/skills_feature.md), [templates_feature](../reference/templates_feature.md), [triggers_feature](../reference/triggers_feature.md), [tools_feature](../reference/tools_feature.md), [governance_feature](../sdlc/governance_feature.md) | Rendered by `App` based on the active section. |
| Shared UI | [shared_features](../reference/shared_features.md), [common_components](common_components.md) | Reusable chat shells, pickers, uploaders, and modals. |
| State stores | [store](../storage/store.md) | Workflow, trigger, and global UI state. |
| Utilities | [utils](../reference/utils.md), [hooks](../reference/hooks.md) | Thread helpers, ID generation, persistence checks, hover tooltips. |
...
Runtime errors inside the builder are caught by `AppErrorBoundary` (imported from [app_core](../reference/app_core.md)) before they can propagate to the host. This keeps the host shell stable even if a workflow editor, agent factory, or canvas throws.

---

## Related Documentation

- [app_core](../reference/app_core.md) — Main application shell, routing, and top-level state.
...
- [skills_feature](../agents/skills_feature.md) — Skill catalog and skill factory.
- [templates_feature](../reference/templates_feature.md) — Template gallery and admin operations.
- [triggers_feature](../reference/triggers_feature.md) — Trigger designer and execution history.
- [tools_feature](../reference/tools_feature.md) — Tool catalog management.
...
- [shared_features](../reference/shared_features.md) — Cross-feature shared components.
- [store](../storage/store.md) — Client-side state management.
- [utils](../reference/utils.md) — Helper utilities.
