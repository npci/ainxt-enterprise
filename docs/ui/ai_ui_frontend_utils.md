...
|------------|-------|----------------|
| [ai_ui_frontend_utils_chat_message](../chat/ai_ui_frontend_utils_chat_message.md) | `kbChat.js`, `messageContent.js` | Distinguish KB chats from regular chats and clean assistant/user message content. |
...
| [ai_ui_frontend_utils_security](../ai_ui_frontend_utils_security.md) | `securityValidation.js` | Validate form input and guard against XSS, dangerous identifiers, and malformed URLs. |
...
- [ppt_wizard](../reference/ppt_wizard.md) and [presenton_lib](../reference/presenton_lib.md) — consumers and backend integration for PPT generation.
