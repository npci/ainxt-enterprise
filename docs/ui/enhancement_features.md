...
> **See also:** [chat.md](../chat/chat.md) for the full Chat component architecture, [kb_chat.md](../knowledge/kb_chat.md) for the KbChat component.
...
```javascript
{
  md:        "!generated image",  // Markdown for inline rendering
...
> **See also:** [gateway.md](../core/gateway.md) for the full gateway architecture, [shared_core.md](../core/shared_core.md) for compliance engine and model router details.
