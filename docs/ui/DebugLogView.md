...
|------------|-------------|
| [ChatPanel](../chat/ChatPanel.md) | **Parent host.** Toggles DebugLogView as a full-swap overlay. Owns the SSE event loop that populates `runContext` via `pushDebugRow`. |
