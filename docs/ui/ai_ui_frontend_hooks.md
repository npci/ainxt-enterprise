...
- `useDesktop.js` is the primary integration point between the web frontend and the `desktop_app` module. For the Electron side of the contract, see [desktop_app](../clients/desktop_app.md).
