...
2. **Backend SDLC events API** — the [sdlc_router](../sdlc/sdlc_router.md) exposes `/sdlc/runs/{runId}/events` and is consumed via `apiFetch` from [config](../ui/ai_ui_frontend_app_core.md#config).
