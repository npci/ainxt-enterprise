...
- [ai_ui_frontend_app_core.md](../ui/ai_ui_frontend_app_core.md)
...
- ai_ui_frontend.md — parent frontend subsystem overview.
- [ai_ui_frontend_app_core.md](../ui/ai_ui_frontend_app_core.md) — top-level application shell that may render the brand mark.
- [sidebar.md](Sidebar.md) — primary navigation consumer.
- [login.md](../auth/login.md) — authentication screen consumer.
