...
> **Related Modules:** [voice_mode](voice_mode.md), [voice_and_tts](voice_and_tts.md), [llm_proxy_main](../llm/llm_proxy_main.md), [whisper_service](whisper_service.md), [kb_chat](../knowledge/kb_chat.md)
...
| [llm_proxy_main](../llm/llm_proxy_main.md) | LLM proxy TTS endpoint (`llm_tts`) — production TTS routing target |
