...
def _run_review_phase(run_id: str, diff_text: str, plan: dict) -> dict:
    ...
    try:
        ...
        review_prompt = (
            ...
            "as out-of-scope.\n"
            "- Only flag a file as out-of-scope if it is in the diff but appears in NEITHER "
            "the MODIFIED FILES nor the NEW FILES list, or if a hunk clearly does work the "
            "intended approach does not call for.\n"
