...
def review_model() -> str:
    """Defaults to the platform Sonnet workhorse (CLAUDE_PRIMARY_MODEL —
    claude-sonnet-4-6 per CLAUDE.md model policy)."""
    return _env_str("SDLC_GOVERNANCE_REVIEW_MODEL", CLAUDE_PRIMARY_MODEL)
