...
class MCPRegistry:
    ...
    def _register_tools(self) -> None:
        ...
        # ========================================================
        # Non-engineering MCP tools — internally authored. (An earlier
        # version of this comment said "vendored from D:\MCPs\mcp_tools";
        # that referred to the author's own local working folder during
        # development, not a third-party source — corrected 2026-09-05.)
