 ...
 *                   For CLI versions that don't speak ACP.
 *
 * Selection is by the AINXT_CLI_PROTOCOL env var, set once in the launcher:
 *
 *     AINXT_CLI_PROTOCOL=acp          (or "new")   [DEFAULT]
 *     AINXT_CLI_PROTOCOL=streamjson   (or "old")
 *
 ...
 * falls back to "acp" rather than failing, so a misconfigured launcher still
 * starts.
 */
...
function resolveProtocol() {
  ...
  // Unset / unrecognised → acp (the default).
  return "acp";
}
