...
"use strict";
/**
 * Desktop-managed conversation history for Cowork/Code.
 *
 ...
 * (= the working folder).
 *
 * Store: ~/.ainxt/cowork-history.json
...
function _file() {
  return path.join(os.homedir(), ".ainxt", "cowork-history.json");
}
...
function _save(store) {
  try {
    ...
    console.error("[cowork-history] save failed:", e.message);
  }
}
