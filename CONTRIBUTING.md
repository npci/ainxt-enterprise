...
1. **The licence permits it and is compatible with MIT.** Permissive
   (MIT/BSD/Apache-2.0/ISC) is fine; strong copyleft (GPL/AGPL) is not. LGPL is
   accepted case-by-case for unmodified, dynamically-linked use only — see
   `THIRD-PARTY-NOTICES.md` §1.5.
2. **The origin is recorded** in `NOTICE` / `THIRD-PARTY-NOTICES.md`:
