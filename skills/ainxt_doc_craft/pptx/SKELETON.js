...
// The figures below are illustrative. REPLACE them with numbers from the user's
// request; if the user gave no numbers, drop this slide rather than inventing KPIs.
...
d.evidence('REPLACE — what the numbers mean', [
  ...
  'REPLACE — third point',
              ...
              data: [{ name: 'REPLACE — series name',
                       labels: ['Oct', 'Nov', 'Dec'],
                       values: [2.1, 1.4, 0.9] }] } });
// The chart values above are illustrative — replace them with the user's data, and
// omit the visual entirely if there is no real data to plot.
