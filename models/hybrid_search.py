...
# ``ABStudio/backend/app/core/kb_retriever.py``. The fields are read by key
...
def pgvector_search(repo_filter, question, top_k=10, user_ctx: dict = None, file_filter: list = None):
    ...
    try:
        ...
        # Embedding provider is driven by DEPLOYMENT_MODE in core/config.py.
        # MUST match the model used at index time — changing requires re-indexing.
